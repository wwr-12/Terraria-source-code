...
namespace Terraria.Graphics
{
	public class SpriteViewMatrix
	{
		...
		private void Rebuild()
		{
			...
			Vector2 vector3 = (_translation = vector2 - vector2 / _zoom);
			_zoomMatrix = Matrix.CreateTranslation(0f - vector3.X, 0f - vector3.Y, 0f) * Matrix.CreateScale(_zoom.X, _zoom.Y, 1f);
