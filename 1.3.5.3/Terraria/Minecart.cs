...
namespace Terraria
{
	public static class Minecart
	{
		...
		public static float TrackRotation(ref float rotation, Vector2 Position, int Width, int Height, bool followDown, bool followUp, Action<Vector2> MinecartDust)
		{
			...
			TrackCollision(ref Position2, ref Velocity, ref lastBoost, Width, Height, followDown, followUp, 0, trackOnly: true, MinecartDust);
			Position2 += Velocity;
			Velocity = new Vector2(12f, 0f);
			TrackCollision(ref Position3, ref Velocity, ref lastBoost, Width, Height, followDown, followUp, 0, trackOnly: true, MinecartDust);
			Position3 += Velocity;
