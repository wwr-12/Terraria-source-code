...
namespace Terraria
{
	public class Framing
	{
		...
		public static void SelfFrame8Way(int i, int j, Tile centerTile, bool resetFrame)
		{
			...
			ushort num = TileID.Sets.GemsparkFramingTypes[centerTile.type];
			...
			if (blockStyle.top)
			{
				...
				if (tileSafely.active() && TileID.Sets.GemsparkFramingTypes[tileSafely.type] == num)
				{
			...
			if (blockStyle.left)
			{
				...
				if (tileSafely2.active() && TileID.Sets.GemsparkFramingTypes[tileSafely2.type] == num)
				{
			...
			if (blockStyle.right)
			{
				...
				if (tileSafely3.active() && TileID.Sets.GemsparkFramingTypes[tileSafely3.type] == num)
				{
			...
			if (blockStyle.bottom)
			{
				...
				if (tileSafely4.active() && TileID.Sets.GemsparkFramingTypes[tileSafely4.type] == num)
				{
			...
			if (blockStyle2.left && blockStyle3.top)
			{
				...
				if (tileSafely5.active() && TileID.Sets.GemsparkFramingTypes[tileSafely5.type] == num)
				{
			...
			if (blockStyle2.right && blockStyle4.top)
			{
				...
				if (tileSafely6.active() && TileID.Sets.GemsparkFramingTypes[tileSafely6.type] == num)
				{
			...
			if (blockStyle5.left && blockStyle3.bottom)
			{
				...
				if (tileSafely7.active() && TileID.Sets.GemsparkFramingTypes[tileSafely7.type] == num)
				{
			...
			if (blockStyle5.right && blockStyle4.bottom)
			{
				...
				if (tileSafely8.active() && TileID.Sets.GemsparkFramingTypes[tileSafely8.type] == num)
				{
			...
			Point16 point = selfFrame8WayLookup[num2][centerTile.frameNumber()];
