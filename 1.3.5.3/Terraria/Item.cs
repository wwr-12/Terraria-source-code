...
namespace Terraria
{
	public class Item : Entity
	{
		...
		public static void DropCache(Vector2 pos, Vector2 spread, int t, bool stopCaching = true)
		{
			...
			int num = itemCaches[t];
			itemCaches[t] = (stopCaching ? (-1) : 0);
			Item item = new Item();
			item.SetDefaults(t);
			while (num > 0)
			{
				...
				NewItem((int)pos.X, (int)pos.Y, (int)spread.X, (int)spread.Y, t, num2);
				num -= num2;
			}
		}
			...
			else
			{
				...
				if (!beingGrabbed)
				{
					...
					if (owner == Main.myPlayer && flag && (createTile >= 0 || createWall > 0 || (ammo > 0 && !notAmmo) || consumable || (type >= 205 && type <= 207) || type == 1128 || type == 530 || dye > 0 || paint > 0 || material) && stack < maxStack)
					{
						...
						{
							if (Main.item[j].active && Main.item[j].type == type && Main.item[j].stack > 0 && Main.item[j].owner == owner && Math.Abs(position.X + (float)(width / 2) - (Main.item[j].position.X + (float)(Main.item[j].width / 2))) + Math.Abs(position.Y + (float)(height / 2) - (Main.item[j].position.Y + (float)(Main.item[j].height / 2))) < 30f)
							{
					...
					if (Main.netMode != 2 && Main.expertMode && owner == Main.myPlayer && type >= 71 && type <= 74)
					{
						...
						for (int k = 0; k < 200; k++)
						{
							...
							if (rectangle.Intersects(rectangle2))
							{
								...
								{
									NetMessage.SendData(92, -1, -1, null, num13, num12, position.X, position.Y);
								}
								if (stack <= 0)
								{
									SetDefaults();
					...
					bool num14 = Collision.WetCollision(position, width, height);
					if (Collision.honey)
					{
						honeyWet = true;
					}
							...
							if (wetCount == 0)
							{
								...
								if (!flag2)
								{
									if (honeyWet)
									{
										for (int l = 0; l < 5; l++)
										{
											int num15 = Dust.NewDust(new Vector2(position.X - 6f, position.Y + (float)(height / 2) - 8f), width + 12, 24, 152);
											Main.dust[num15].velocity.Y -= 1f;
									...
									else
									{
										for (int m = 0; m < 10; m++)
										{
											int num16 = Dust.NewDust(new Vector2(position.X - 6f, position.Y + (float)(height / 2) - 8f), width + 12, 24, Dust.dustWater());
								...
								else
								{
									for (int n = 0; n < 5; n++)
									{
										int num17 = Dust.NewDust(new Vector2(position.X - 6f, position.Y + (float)(height / 2) - 8f), width + 12, 24, 35);
										Main.dust[num17].velocity.Y -= 1.5f;
					...
					if (lavaWet)
					{
						if (type == 267)
						{
							if (Main.netMode != 1)
							{
								...
								{
									if (Main.npc[num18].active && Main.npc[num18].type == 22)
									{
										if (Main.netMode == 2)
										{
											NetMessage.SendData(28, -1, -1, null, num18, 9999f, 10f, -Main.npc[num18].direction);
										}
										Main.npc[num18].StrikeNPCNoInteraction(9999, 10f, -Main.npc[num18].direction);
					...
					if (type == 3191)
					{
						...
						num19 *= (Main.essScale + 0.5f) / 2f;
						Lighting.AddLight((int)((position.X + (float)(width / 2)) / 16f), (int)((position.Y + (float)(height / 2)) / 16f), 0.3f * num19, 0.1f * num19, 0.25f * num19);
					}
					else if (type == 520 || type == 3454)
					{
						float num20 = (float)Main.rand.Next(90, 111) * 0.01f;
						num20 *= Main.essScale;
						Lighting.AddLight((int)((position.X + (float)(width / 2)) / 16f), (int)((position.Y + (float)(height / 2)) / 16f), 0.5f * num20, 0.1f * num20, 0.25f * num20);
					}
					else if (type == 521 || type == 3455)
					{
						float num21 = (float)Main.rand.Next(90, 111) * 0.01f;
						num21 *= Main.essScale;
						Lighting.AddLight((int)((position.X + (float)(width / 2)) / 16f), (int)((position.Y + (float)(height / 2)) / 16f), 0.25f * num21, 0.1f * num21, 0.5f * num21);
					}
					else if (type == 547 || type == 3453)
					{
						float num22 = (float)Main.rand.Next(90, 111) * 0.01f;
						num22 *= Main.essScale;
						Lighting.AddLight((int)((position.X + (float)(width / 2)) / 16f), (int)((position.Y + (float)(height / 2)) / 16f), 0.5f * num22, 0.3f * num22, 0.05f * num22);
					}
					else if (type == 548)
					{
						float num23 = (float)Main.rand.Next(90, 111) * 0.01f;
						num23 *= Main.essScale;
						Lighting.AddLight((int)((position.X + (float)(width / 2)) / 16f), (int)((position.Y + (float)(height / 2)) / 16f), 0.1f * num23, 0.1f * num23, 0.6f * num23);
					}
					else if (type == 575)
					{
						float num24 = (float)Main.rand.Next(90, 111) * 0.01f;
						num24 *= Main.essScale;
						Lighting.AddLight((int)((position.X + (float)(width / 2)) / 16f), (int)((position.Y + (float)(height / 2)) / 16f), 0.1f * num24, 0.3f * num24, 0.5f * num24);
					}
					else if (type == 549)
					{
						float num25 = (float)Main.rand.Next(90, 111) * 0.01f;
						num25 *= Main.essScale;
						Lighting.AddLight((int)((position.X + (float)(width / 2)) / 16f), (int)((position.Y + (float)(height / 2)) / 16f), 0.1f * num25, 0.5f * num25, 0.2f * num25);
					}
					else if (type == 58 || type == 1734 || type == 1867)
					{
						float num26 = (float)Main.rand.Next(90, 111) * 0.01f;
						num26 *= Main.essScale * 0.5f;
						Lighting.AddLight((int)((position.X + (float)(width / 2)) / 16f), (int)((position.Y + (float)(height / 2)) / 16f), 0.5f * num26, 0.1f * num26, 0.1f * num26);
					}
					else if (type == 184 || type == 1735 || type == 1868)
					{
						float num27 = (float)Main.rand.Next(90, 111) * 0.01f;
						num27 *= Main.essScale * 0.5f;
						Lighting.AddLight((int)((position.X + (float)(width / 2)) / 16f), (int)((position.Y + (float)(height / 2)) / 16f), 0.1f * num27, 0.1f * num27, 0.5f * num27);
					}
					else if (type == 522)
					{
						float num28 = (float)Main.rand.Next(90, 111) * 0.01f;
						num28 *= Main.essScale * 0.2f;
						Lighting.AddLight((int)((position.X + (float)(width / 2)) / 16f), (int)((position.Y + (float)(height / 2)) / 16f), 0.5f * num28, 1f * num28, 0.1f * num28);
					}
					else if (type == 1332)
					{
						float num29 = (float)Main.rand.Next(90, 111) * 0.01f;
						num29 *= Main.essScale * 0.2f;
						Lighting.AddLight((int)((position.X + (float)(width / 2)) / 16f), (int)((position.Y + (float)(height / 2)) / 16f), 1f * num29, 1f * num29, 0.1f * num29);
					}
					else if (type == 3456)
					{
					...
					{
						int num32 = Main.rand.Next(18, 24);
						for (int num33 = 0; num33 < num32; num33++)
						{
							int num34 = Dust.NewDust(base.Center, 0, 0, 61, 0f, 0f, 0, default(Color), 1.7f);
							Main.dust[num34].velocity *= 8f;
							Main.dust[num34].velocity.Y -= 1f;
							Main.dust[num34].position = Vector2.Lerp(Main.dust[num34].position, base.Center, 0.5f);
				...
				if (type == 501)
				{
					...
					{
						int num35 = Dust.NewDust(position, width, height, 55, 0f, 0f, 200, color);
						Main.dust[num35].velocity *= 0.3f;
						Main.dust[num35].scale *= 0.5f;
					}
				}
				else if (type == 3822)
				{
				...
				if (Main.netMode == 2 && owner != Main.myPlayer)
				{
					...
					{
						release = 0;
						NetMessage.SendData(39, owner, -1, null, i);
					}
				}
				if (wet)
				{
		...
		{
			return NewItem((int)pos.X, (int)pos.Y, (int)randomBox.X, (int)randomBox.Y, Type, Stack, noBroadcast, prefixGiven, noGrabDelay, reverseLookup);
		}
		...
		{
			return NewItem((int)pos.X, (int)pos.Y, Width, Height, Type, Stack, noBroadcast, prefixGiven, noGrabDelay, reverseLookup);
		}
		...
		public static int NewItem(int X, int Y, int Width, int Height, int Type, int Stack = 1, bool noBroadcast = false, int pfix = 0, bool noGrabDelay = false, bool reverseLookup = false)
		{
			...
			if (itemCaches[Type] != -1)
			{
				itemCaches[Type] += Stack;
				return 400;
			}
			if (Main.netMode != 1)
			{
			...
			if (Main.netMode == 2 && !noBroadcast)
			{
				...
				NetMessage.SendData(21, -1, -1, null, num, num4);
