	...
	public class SolarSky : CustomSky
	{
		...
		public override void Draw(SpriteBatch spriteBatch, float minDepth, float maxDepth)
		{
			...
			for (int j = num; j < num2; j++)
			{
				...
				{
					spriteBatch.Draw(_meteorTexture, position, new Rectangle(0, num4 * (_meteorTexture.Height / 4), _meteorTexture.Width, _meteorTexture.Height / 4), Color.White * num3 * _fadeOpacity, 0f, Vector2.Zero, vector4.X * 5f * _meteors[j].Scale, SpriteEffects.None, 0f);
				}
			}
		}
