	...
	public class ScreenObstruction
	{
		...
		public static void Draw(SpriteBatch spriteBatch)
		{
			if (screenObstruction != 0f)
			{
				...
				spriteBatch.Draw(Main.magicPixel, destinationRectangle, new Rectangle(0, 0, 1, 1), color);
				spriteBatch.Draw(Main.magicPixel, destinationRectangle2, new Rectangle(0, 0, 1, 1), color);
				spriteBatch.Draw(Main.magicPixel, destinationRectangle3, new Rectangle(0, 0, 1, 1), color);
				spriteBatch.Draw(Main.magicPixel, destinationRectangle4, new Rectangle(0, 0, 1, 1), color);
