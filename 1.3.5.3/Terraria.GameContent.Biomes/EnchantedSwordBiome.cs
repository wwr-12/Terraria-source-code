...
namespace Terraria.GameContent.Biomes
{
	public class EnchantedSwordBiome : MicroBiome
	{
		public override bool Place(Point origin, StructureMap structures)
		{
			...
			if (!structures.CanPlace(new Rectangle(point.X - (int)(20f * num), point.Y - 20, (int)(40f * num), 40)))
			{
				return false;
			}
			...
			structures.AddStructure(new Rectangle(point.X - (int)(20f * num), point.Y - 20, (int)(40f * num), 40), 4);
			return true;
		}
	}
}
