	...
	public class AchievementInitializer
	{
		public static void Load()
		{
			if (Main.netMode != 2)
			{
				...
				achievement.AddCondition(ItemPickupCondition.Create(2775, 2746, 3505, 654, 3517, 7, 3493, 2780, 1513, 2516, 660, 3481, 657, 922, 3511, 2785, 3499, 3487, 196, 367, 104, 797, 2320, 787, 1234, 1262, 3465, 204, 217, 1507, 3524, 3522, 3525, 3523, 1305));
				Main.Achievements.Register(achievement);
				...
				achievement.AddCondition(TileDestroyedCondition.Create(226));
				Main.Achievements.Register(achievement);
				...
				achievement.AddCondition(ItemPickupCondition.Create(1513, 938, 963, 977, 1300, 1254, 1514, 679, 759, 1446, 1445, 1444, 1183, 1266, 671));
				Main.Achievements.Register(achievement);
				...
				achievement.AddCondition(NPCKilledCondition.Create(113, 114));
				achievement.AddCondition(NPCKilledCondition.Create(125, 126));
				achievement.AddConditions(NPCKilledCondition.CreateMany(4, 35, 50, 222, 113, 134, 127, 262, 245, 439, 398, 370));
				achievement.UseConditionsCompletedTracker();
				Main.Achievements.Register(achievement);
