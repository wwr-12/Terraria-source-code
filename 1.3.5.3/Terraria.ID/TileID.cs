namespace Terraria.ID
{
	public class TileID
	{
		public static class Sets
		{
			...
			{
				public static bool[] Grass = Factory.CreateBoolSet(2, 23, 60, 199, 109);
				...
				public static bool[] Thorn = Factory.CreateBoolSet(32, 352, 69);

				public static bool[] Moss = Factory.CreateBoolSet(182, 180, 179, 381, 183, 181);
			}
			...
			{
				public static int[] CountsAsChair = new int[4] { 15, 79, 89, 102 };

				public static int[] CountsAsTable = new int[10] { 14, 18, 87, 88, 90, 101, 354, 355, 464, 469 };

				public static int[] CountsAsTorch = new int[20]
				{
					4, 33, 34, 35, 42, 49, 93, 95, 98, 100,
					149, 173, 174, 270, 271, 316, 317, 318, 372, 405
				};
			...
			public static bool[] DrawsWalls = Factory.CreateBoolSet(10, 54, 138, 388, 191, 137, 328, 162, 387, 48, 232, 127, 459);
			...
			public static bool[] GrassSpecial = Factory.CreateBoolSet(70, 60);
			...
			public static bool[] GeneralPlacementTiles = Factory.CreateBoolSet(true, 225, 41, 43, 44, 226, 203, 112, 25, 70, 151, 21, 31, 467, 12);
			...
			public static bool[] BlocksStairs = Factory.CreateBoolSet(386, 387, 54);
			...
			public static bool[] NeedsGrassFraming = Factory.CreateBoolSet();

			public static int[] NeedsGrassFramingDirt = Factory.CreateIntSet(0);

			public static bool[] ChecksForMerge = Factory.CreateBoolSet(0, 2, 60, 70, 199, 109, 57, 58, 75, 76, 147, 161, 164, 163, 200, 162, 189, 196, 224, 191, 383, 211, 225, 59, 226, 396, 397, 398, 399, 402, 400, 401, 403, 404, 234, 112, 407);

			public static bool[] FramesOnKillWall = Factory.CreateBoolSet(440, 240, 241, 242, 245, 246, 4, 136, 334, 132, 55, 395, 425, 440);

			public static bool[] AvoidedByNPCs = Factory.CreateBoolSet(21, 467, 55, 85, 395, 88, 463, 334, 29, 97, 99, 356, 425, 440, 209, 441, 468);

			public static bool[] InteractibleByNPCs = Factory.CreateBoolSet(17, 77, 133, 12, 26, 35, 36, 55, 395, 21, 467, 29, 97, 88, 99, 463, 33, 372, 174, 49, 100, 173, 78, 79, 94, 96, 101, 50, 103, 282, 106, 114, 125, 171, 172, 207, 215, 220, 219, 244, 228, 237, 247, 128, 269, 354, 355, 377, 287, 378, 390, 302, 405, 406, 411, 425, 209, 441, 468, 452, 454, 455, 457, 462);

			public static bool[] HousingWalls = Factory.CreateBoolSet(11, 389, 386);

			public static bool[] BreakableWhenPlacing = Factory.CreateBoolSet(324, 186, 187, 185, 165);
			...
			public static bool[] Falling = Factory.CreateBoolSet(53, 234, 112, 116, 224, 123);

			public static bool[] Ore = Factory.CreateBoolSet(7, 166, 6, 167, 9, 168, 8, 169, 22, 204, 37, 58, 107, 221, 108, 222, 111, 223, 211);

			public static bool[] ForceObsidianKill = Factory.CreateBoolSet(21, 467, 88);
		}
