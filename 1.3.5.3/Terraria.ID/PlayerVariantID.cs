namespace Terraria.ID
{
	public static class PlayerVariantID
	{
		public class Sets
		{
			public static bool[] Male = Factory.CreateBoolSet(0, 1, 2, 3, 8);

			public static int[] AltGenderReference = Factory.CreateIntSet(0, 0, 4, 4, 0, 1, 5, 5, 1, 2, 6, 6, 2, 3, 7, 7, 3, 8, 9, 9, 8);
