namespace Terraria.ID
{
	public class WallID
	{
		public static class Sets
		{
			...
			{
				public static bool[] Grass = Factory.CreateBoolSet(63, 64, 65, 66, 67, 68, 69, 70, 81);

				public static bool[] Stone = Factory.CreateBoolSet(1, 3, 28, 83);

				public static bool[] Sandstone = Factory.CreateBoolSet(187, 220, 222, 221);

				public static bool[] HardenedSand = Factory.CreateBoolSet(216, 217, 219, 218);
			}

			public static SetFactory Factory = new SetFactory(231);

			public static bool[] Transparent = Factory.CreateBoolSet(88, 89, 90, 91, 92);
