...
public class EmoteBubble
{
	...
	public void Draw(SpriteBatch sb)
	{
		...
		if (emote >= 0)
		{
			if ((emote == 87 || emote == 89) && (effect & SpriteEffects.FlipHorizontally) != SpriteEffects.None)
			{
		...
		else if (emote == -1)
		{
			...
			sb.Draw(value, position + new Vector2(((effect & SpriteEffects.FlipHorizontally) != SpriteEffects.None) ? 1 : (-1), -value2.Height + 3), null, Color.White, 0f, new Vector2(value.Width / 2, 0f), num, effect, 0f);
		}
	}
