...
public class TileObjectData
{
	...
	public bool UsesGlobalLiquidChecks
	{
		get
		{
			return _useGlobalLiquidChecks;
		}
		set
		{
			WriteCheck();
			_useGlobalLiquidChecks = value;
		}
	}
	...
	public GetStyleMethod GetStyleOverride
	{
		get
		{
			if (_placementHooks == null)
			{
				return _baseObject.GetStyleOverride;
			}
			return _placementHooks.getStyleMethod;
		}
		set
		{
			WriteCheck();
			...
			_placementHooks.getStyleMethod = value;
		}
	}
	...
	public static void Initialize()
	{
		...
		newTile.LavaDeath = true;
		newTile.DrawFlipHorizontal = true;
		addBaseTile(out Style1x1Plant_Height22);
		newTile.CopyFrom(Style1x1);
		newTile.StyleHorizontal = true;
		newTile.WaterPlacement = LiquidPlacement.NotAllowed;
		newTile.WaterDeath = false;
		newTile.LavaDeath = true;
		newTile.DrawFlipHorizontal = true;
		addBaseTile(out Style1x1Plant_Height34);
		...
		newTile.LavaDeath = false;
		newTile.ApplyNaturalObjectRules();
		addBaseTile(out Style1x1Drip);
		newTile.CopyFrom(Style1x1Drip);
		addTile(373);
		newTile.CopyFrom(Style1x1Drip);
		addTile(374);
		newTile.CopyFrom(Style1x1Drip);
		...
		newSubTile.ApplyNaturalObjectRules();
		newSubTile.StyleHorizontal = true;
		newSubTile.AnchorBottom = AnchorData.Empty;
		newSubTile.AnchorTop = new AnchorData(AnchorType.SolidTile | AnchorType.SolidSide | AnchorType.AlternateTile | AnchorType.SolidBottom, newTile.Width, 0);
		addSubTile(1);
		newSubTile.CopyFrom(Style1x1);
		newSubTile.StyleHorizontal = true;
		newSubTile.ApplyNaturalObjectRules();
