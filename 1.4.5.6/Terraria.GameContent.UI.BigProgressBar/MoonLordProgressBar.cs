...
public class MoonLordProgressBar : IBigProgressBar
{
	...
	public bool ValidateAndCollectNecessaryInfo(ref BigProgressBarInfo info)
	{
		...
		_referenceDummy.SetDefaults(398, matchingSpawnParams);
		num += _referenceDummy.lifeMax;
		_referenceDummy.SetDefaults(396, matchingSpawnParams);
		num += _referenceDummy.lifeMax;
		_referenceDummy.SetDefaults(397, matchingSpawnParams);
		num += _referenceDummy.lifeMax;
		num += _referenceDummy.lifeMax;
		float num2 = 0f;
