...
public static class ItemVariants
{
	...
	public static ItemVariantCondition MechdusaWorld;
	...
	static ItemVariants()
	{
		...
		MechdusaWorld = new ItemVariantCondition(NetworkText.FromKey("ItemVariantCondition.MechdusaWorld"), () => SpecialSeedFeatures.Mechdusa);
		...
		AddVariant(556, DisabledBossSummonVariant, MechdusaWorld);
		AddVariant(557, DisabledBossSummonVariant, MechdusaWorld);
		AddVariant(544, DisabledBossSummonVariant, MechdusaWorld);
		AddVariant(5334, EnabledVariant, MechdusaWorld);
	}
}
