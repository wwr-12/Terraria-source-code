...
public static class GoreID
{
	public static class Sets
	{
		...
		public static bool[] IsDrip = Factory.CreateBoolSet(false, 706, 714, 713, 707, 715, 711, 1147, 709, 710, 708, 712, 716, 717, 943, 1160, 1161, 1162, 1383);
	}

	public const int Cloud1 = 11;

	public const int Cloud2 = 12;

	public const int Cloud3 = 13;

	public const int FireImpHead = 45;

	public const int FireImpArm = 46;

	public const int FireImpLeg = 47;

	public const int PotLightBrown1 = 51;

	public const int PotLightBrown2 = 52;

	public const int PotLightBrown3 = 53;
	...
	public const int HornetHead = 70;

	public const int HornetBody = 71;

	public const int PotDarkBrown1 = 166;

	public const int PotDarkBrown2 = 167;

	public const int PotDarkBrown3 = 168;

	public const int PotOrnate1 = 169;

	public const int PotOrnate2 = 170;

	public const int PotOrnate3 = 171;

	public const int PotOrnateBrown1 = 172;

	public const int PotOrnateBrown2 = 173;

	public const int PotOrnateBrown3 = 174;

	public const int PotIcy1 = 197;

	public const int PotIcy2 = 198;

	public const int PotJungle1 = 199;

	public const int PotJungle2 = 200;

	public const int PotSkull1 = 201;

	public const int PotSkull2 = 202;

	public const int PotObsidian1 = 203;

	public const int PotObsidian2 = 204;

	public const int PotPyramid1 = 217;

	public const int PotPyramid2 = 218;

	public const int PotPyramid3 = 219;

	public const int MossHornetHead = 229;

	public const int MossHornetBody = 230;

	public const int PotTemple1 = 315;

	public const int PotTemple2 = 316;
	...
	public const int ShimmerDrip = 1383;

	public const int HornetHeadHoney = 1384;

	public const int HornetHeadSpikey = 1385;

	public const int PufferfishSmallHead = 1386;

	public const int PufferfishSmallTail = 1387;

	public const int PufferfishBigChunk1 = 1388;

	public const int PufferfishBigChunk2 = 1389;

	public const int PufferfishBigTail = 1390;

	public const int MossZombieHead = 1391;

	public const int MossZombieChunk1 = 1392;

	public const int MossZombieChunk2 = 1393;

	public const int PrettyMirror1 = 1394;

	public const int PrettyMirror2 = 1395;

	public const int PrettyMirror3 = 1396;

	public const int PrettyMirror4 = 1397;

	public const int RedHatSkeletronHead1 = 1398;

	public const int RedHatSkeletronHead2 = 1399;

	public const int RedHatSkeletronHead3 = 1400;

	public const int RedHatSkeletronHand1 = 1401;

	public const int RedHatSkeletronHand2 = 1402;

	public const int OrcaHead = 1403;

	public const int OrcaTail = 1404;

	public const int OrcaChunk1 = 1405;

	public const int OrcaChunk2 = 1406;

	public static readonly int Count = 1407;
}
