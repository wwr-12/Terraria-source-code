...
public class GlowMaskID
{
	...
	public const short DeadCellsPotionStation = 353;

	public const short DeadCellsMushroomBoi = 354;

	public const short DeadCellsFlint = 355;

	public const short DeadCellsBarrel = 356;

	public const short DeadCellsBeheadedHead = 357;

	public const short EelWhip = 358;

	public const short Shimmerfall = 359;

	public const short FireImp = 360;

	public const short ShimmerfallWall = 361;

	public const short LavaCloud = 362;

	public const short ChickenBonesRobeLeg = 363;

	public const short ChickenBonesRobeTorso = 364;

	public const short ChickenBonesHead = 365;

	public const short ChickenBonesWings = 366;

	public const short UpgradedMiningHead = 367;

	public const short CRTMonolith = 368;

	public const short RetroMonolith = 369;

	public const short BatMountBody = 370;

	public const short NoirMonolith = 371;

	public const short RainbowPhaseblade = 372;

	public const short RainbowPhasesaber = 373;

	public const short TrueCopperShortsword = 374;

	public const short KazzymodusHood = 375;

	public const short KazzymodusChestpiece = 376;

	public const short PalworldDigtoise = 377;

	public const short LunasHead = 378;

	public static readonly short Count = 379;
}
