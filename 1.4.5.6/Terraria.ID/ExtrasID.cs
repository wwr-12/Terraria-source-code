...
public class ExtrasID
{
	...
	public const short DeadCellsBeheadedHead = 266;

	public const short GenericCircle = 267;

	public const short ShockIcon = 268;

	public const short DeadCellsBarrelExplosion = 269;

	public const short MoonlordWhipEye = 270;

	public const short VelociraptorMountBody = 271;

	public const short VelociraptorMountArm = 272;

	public const short RatMountBody = 273;

	public const short BatMountBody = 274;

	public const short JimCloakShoulder = 275;

	public const short JimsHelmetMetal = 276;

	public const short JimsBreastplateMetal = 277;

	public const short JimsLeggingsMetal = 278;

	public const short ChippysHeadbandTassels = 279;

	public const short SunSunglasses = 280;

	public const short FakeButterfly = 281;

	public const short TeamBasedSpawnMapIcons = 282;

	public const short RainbowBoulderPetAura = 283;

	public const short HeroicisHeadMount = 284;

	public const short AcornSlingshotHeldItem = 285;

	public const short AuroraNoise = 286;

	public const short AuroraShape = 287;

	public const short LightningShape = 288;

	public const short LibrarianSkeletonCircle = 289;

	public const short PixieMountBackLayer = 290;

	public const short PixieMountFrontLayer = 291;

	public const short HouseCheckBlock = 292;

	public const short HouseCheckDot = 293;

	public const short HouseCheckMarkerLight = 294;

	public const short HouseCheckMarkerChair = 295;

	public const short HouseCheckMarkerDoor = 296;

	public const short HouseCheckMarkerTable = 297;

	public const short HouseCheckHammer = 298;

	public const short PylonOffscreenIndicator = 299;

	public const short LunaHeadEars = 300;

	public const short Chillet = 301;

	public const short ChilletIgnis = 302;

	public const short FoxsparksHeld = 303;

	public static readonly short Count = 304;
}
