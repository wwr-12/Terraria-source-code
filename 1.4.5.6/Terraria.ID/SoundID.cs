...
public class SoundID
{
	...
	public static readonly LegacySoundStyle NPCHit58 = new LegacySoundStyle(3, 58);
	...
	public static readonly LegacySoundStyle NPCDeath67 = new LegacySoundStyle(4, 67);

	public static readonly LegacySoundStyle NPCDeath68 = new LegacySoundStyle(4, 68);
	...
	public static readonly LegacySoundStyle Item179 = new LegacySoundStyle(2, 179).WithVolume(0.6f);

	public static readonly LegacySoundStyle Item180 = new LegacySoundStyle(2, 180);

	public static readonly LegacySoundStyle Item181 = new LegacySoundStyle(2, 181);

	public static readonly LegacySoundStyle Item182 = new LegacySoundStyle(2, 182);

	public static readonly LegacySoundStyle Item183 = new LegacySoundStyle(2, 183);

	public static readonly LegacySoundStyle Item184 = new LegacySoundStyle(2, 184);

	public static readonly LegacySoundStyle Item185 = new LegacySoundStyle(2, 185);

	public static readonly LegacySoundStyle Item186 = new LegacySoundStyle(2, 186);

	public static readonly LegacySoundStyle Item187 = new LegacySoundStyle(2, 187);

	public static readonly LegacySoundStyle Item188 = new LegacySoundStyle(2, 188);

	public static readonly LegacySoundStyle Item189 = new LegacySoundStyle(2, 189);

	public static readonly LegacySoundStyle Item190 = new LegacySoundStyle(2, 190);

	public static readonly LegacySoundStyle Item191 = new LegacySoundStyle(2, 191);

	public static readonly LegacySoundStyle Item192 = new LegacySoundStyle(2, 192);

	public static readonly LegacySoundStyle Item193 = new LegacySoundStyle(2, 193);
	...
	public static readonly LegacySoundStyle PlayerHurt1 = new LegacySoundStyle(1, 1);

	public static readonly LegacySoundStyle PlayerHurt2 = new LegacySoundStyle(20, 1);
	...
	public static readonly LegacySoundStyle DeadCellsMushroomLand = CreateTrackable("deadcells_mushroom_land").WithVolume(0.35f);

	public static readonly LegacySoundStyle DeadCellsMushroomJump = CreateTrackable("deadcells_mushroom_jump").WithVolume(0.35f);

	public static readonly LegacySoundStyle DeadCellsMushroomExplode = CreateTrackable("deadcells_mushroom_explode").WithVolume(0.15f);

	public static readonly LegacySoundStyle DeadCellsFlintCharge = CreateTrackable("deadcells_flint_charge").WithVolume(0.5f);

	public static readonly LegacySoundStyle DeadCellsFlintRelease = CreateTrackable("deadcells_flint_release").WithVolume(0.5f);

	public static readonly LegacySoundStyle DeadCellsFlintWave = CreateTrackable("deadcells_flint_wave").WithVolume(0.1f);

	public static readonly LegacySoundStyle MeteorShower = CreateTrackable("meteor_shower", 6).WithVolume(0.8f).WithPitchVariance(0.3f);

	public static readonly LegacySoundStyle BestReforge = CreateTrackable("best_reforge").WithPitchVariance(0.1f);

	public static readonly LegacySoundStyle TrashItem = CreateTrackable("trash_item", 2).WithVolume(0.55f).WithPitchVariance(0.25f);

	public static readonly LegacySoundStyle InstantThunder = CreateTrackable("instant_thunder", 3);

	public static readonly LegacySoundStyle SonarPotion = CreateTrackable("sonar_potion").WithVolume(0.65f).WithPitchVariance(0.03f);
	...
	public static readonly LegacySoundStyle FairyHurt = CreateTrackable("player_hit_fairy").WithVolume(0.5f).WithPitchVariance(0.4f);
