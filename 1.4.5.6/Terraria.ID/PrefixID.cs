...
public class PrefixID
{
	...
	public const int Fabled = 85;

	public const int Loyal = 86;

	public const int Worthy = 87;

	public const int Focused = 88;

	public const int Patient = 89;

	public const int Rabid = 90;

	public const int IllTempered = 91;

	public const int Petty = 92;

	public const int Feeble = 93;

	public const int Skittish = 94;

	public const int Eager = 95;

	public const int Ballistic = 96;

	public const int Scraggling = 97;

	public static readonly int Count = 98;
}
