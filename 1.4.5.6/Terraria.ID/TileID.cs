...
public class TileID
{
	public static class Sets
	{
		...
		public static bool[] bonusCutTiles = Factory.CreateBoolSet(false, 233);

		public static bool[] tileMossBrick = Factory.CreateBoolSet(false, 512, 513, 514, 515, 516, 517, 535, 537, 540, 626, 628);

		public static bool[] GeneralPlacementTiles = Factory.CreateBoolSet(true, 225, 41, 481, 43, 482, 44, 483, 226, 203, 112, 25, 70, 151, 21, 31, 696, 467, 12, 665, 639, 138, 664, 711, 712, 713, 714, 715, 716);

		public static bool[] PreventsActuationUnder = Factory.CreateBoolSet(21, 467, 26, 77, 88, 470, 475, 237, 597, 441, 468);
		...
		public static List<int> HallowCountCollection = new List<int> { 109, 492, 117, 116, 164, 402, 403, 115, 110, 113 };

		public static bool[] HallowBiomeSight = Factory.CreateBoolSet(109, 492, 117, 116, 164, 402, 403, 115, 110, 113);
		...
		public static bool[] UsesADifferentTileTypeForNPCSpawning = Factory.CreateBoolSet(false, 421, 422);

		public static bool[] BlocksStairs = Factory.CreateBoolSet(386, 387, 54, 328, 459, 541);

		public static bool[] NotReallySolid = Factory.CreateBoolSet(387, 388, 10);

		public static bool[] BlocksWaterDrawingBehindSelf = Factory.CreateBoolSet(false, 54, 541, 328, 459, 470);

		public static bool[] AllowLightInWater = Factory.CreateBoolSet(false, 54, 541, 328, 459, 748, 750);

		public static bool[] TruncatesWalls = Factory.CreateBoolSet(false, 54, 328, 459, 748);

		public static bool[] FrameImportantEchoCulling = Factory.CreateBoolSet(false, 19, 436, 435, 438, 427, 439, 437, 380);
		...
		public static bool[] ChecksForMerge = Factory.CreateBoolSet(0, 668, 2, 661, 60, 70, 199, 662, 109, 477, 492, 633, 747, 57, 58, 75, 76, 684, 147, 161, 164, 163, 200, 162, 189, 196, 460, 717, 718, 719, 170, 738, 224, 191, 383, 211, 225, 59, 226, 396, 397, 398, 399, 402, 400, 401, 403, 404, 234, 112, 407);

		public static bool[] FramesOnKillWall = Factory.CreateBoolSet(440, 240, 241, 242, 245, 246, 4, 136, 334, 132, 55, 395, 425, 440, 471, 510, 511, 573, 630, 631, 723);
		...
		public static bool[] TouchDamageBleeding = Factory.CreateBoolSet(48, 232, 750);
		...
		public static bool[] Gems = Factory.CreateBoolSet(67, 66, 65, 63, 64, 68);
	...
	public const ushort Stalactite1x1Echo = 693;

	public const ushort Stalactite1x2Echo = 694;

	public const ushort DemonAltarReplica = 695;

	public const ushort ShadowOrbsReplica = 696;

	public const ushort CobwebReplica = 697;

	public const ushort DeadCellsDisplayJar = 698;

	public const ushort DeadCellsPotionStation = 699;

	public const ushort AbigailsFlowerReplica = 700;

	public const ushort GlowTulipReplica = 701;

	public const ushort LifeFruitReplica = 702;

	public const ushort JunglePlantsEcho = 703;

	public const ushort FallenLogEcho = 704;

	public const ushort OasisPlantsEcho = 705;

	public const ushort TerragrimShrineEcho = 706;

	public const ushort BooksEcho = 707;

	public const ushort Shimmerfall = 708;

	public const ushort ShimmerDrip = 709;

	public const ushort PufferfishCage = 710;

	public const ushort RainbowBoulder = 711;

	public const ushort Poulder = 712;

	public const ushort LavaBoulder = 713;

	public const ushort SpiderBoulder = 714;

	public const ushort Ghoulder = 715;

	public const ushort BoulderThatSpawnsPet = 716;

	public const ushort LavaCloud = 717;

	public const ushort StarCloud = 718;

	public const ushort RainbowCloud = 719;

	public const ushort CRTMonolith = 720;

	public const ushort RetroMonolith = 721;

	public const ushort FallenStarBlock = 722;

	public const ushort KiteAnchor = 723;

	public const ushort CritterAnchor = 724;

	public const ushort NoirMonolith = 725;

	public const ushort CannonBall = 726;

	public const ushort TeamBlockRedVariant = 727;

	public const ushort TeamBlockGreenVariant = 728;

	public const ushort TeamBlockBlueVariant = 729;

	public const ushort TeamBlockYellowVariant = 730;

	public const ushort TeamBlockPinkVariant = 731;

	public const ushort TeamBlockWhiteVariant = 732;

	public const ushort RadioThingMonolith = 733;

	public const ushort Feywood = 734;

	public const ushort HallowedBrick = 735;

	public const ushort EasterBlock = 736;

	public const ushort GothicBrick = 737;

	public const ushort FlinxFurBlock = 738;

	public const ushort JellyfishBlock = 739;

	public const ushort ToyBreakerBlock = 740;

	public const ushort PineWoodBlock = 741;

	public const ushort HarpyBlock = 742;

	public const ushort MoonplateBlock = 743;

	public const ushort LibrarianBlock = 744;

	public const ushort SpikeBlock = 745;

	public const ushort OfficeBlock = 746;

	public const ushort ForbiddenBlock = 747;

	public const ushort WaterBlock = 748;

	public const ushort BoulderBlock = 749;

	public const ushort DamagingSpikeBlock = 750;

	public const ushort PalworldDigtoiseSleeping = 751;

	public const ushort PalworldChilletEgg = 752;

	public static readonly ushort Count = 753;
