...
public class ArmorIDs
{
	public class Head
	{
		public class Sets
		{
			...
			public static bool[] UseAltFaceHeadDraw = Factory.CreateBoolSet(false, 3, 4, 6, 7, 9, 17, 22, 27, 28, 31, 32, 37, 38, 39, 40, 42, 43, 45, 46, 47, 48, 49, 50, 57, 58, 61, 66, 69, 70, 72, 74, 75, 76, 77, 78, 82, 83, 86, 89, 93, 98, 101, 103, 104, 105, 107, 108, 109, 110, 111, 115, 118, 120, 122, 123, 124, 127, 128, 129, 131, 132, 134, 135, 136, 137, 142, 146, 147, 148, 149, 150, 151, 152, 153, 154, 155, 156, 157, 162, 164, 165, 168, 169, 170, 171, 172, 173, 174, 175, 176, 177, 178, 179, 185, 186, 187, 188, 189, 192, 193, 194, 200, 201, 202, 204, 207, 208, 209, 210, 211, 213, 214, 230, 236, 237, 239, 240, 241, 251, 254, 255, 258, 260, 266, 268, 269, 270, 271, 261, 8, 12, 30, 35, 36, 73, 79, 80, 84, 85, 87, 88, 90, 91, 102, 112, 141, 160, 180, 196, 205, 257, 256, 291, 292, 283, 287);

			public static bool[] CanDrawOnVelociraptorMount = Factory.CreateBoolSet(false, 212, 241, 274, 277, 5, 278, 34, 205, 41, 42, 30, 8, 84, 79, 33, 91, 90, 99, 35, 4, 256, 257, 36, 85, 80, 1, 112, 2, 215, 201, 202, 199, 194, 206, 262, 259, 234, 226, 238, 250, 280, 232, 225, 223, 224, 219, 220, 216, 263, 273, 264, 267, 18, 19, 24, 21, 26, 25, 16, 14, 12, 275, 65, 51, 56, 40, 29, 81, 94, 95, 62, 67, 44, 68, 121, 114, 116, 113, 92, 106, 100, 96, 97, 141, 143, 145, 139, 140, 144, 126, 130, 133, 159, 158, 161, 166, 183, 181, 178, 184, 182, 13, 64, 60, 59, 73, 63, 117, 138, 160, 10, 235, 197, 195, 203, 191, 228, 233, 227, 217, 218, 245, 243, 244, 242, 231, 229, 222, 265, 272, 279, 15, 163, 288, 289, 290);
		}
		...
		public const int DeadCellsBeheadedHead = 282;

		public const int ChlorophyteVisor = 283;

		public const int ChickenBonesHead = 284;

		public const int UpgradedMiningHead = 285;

		public const int UpgradedFishingHead = 286;

		public const int ChippysHead = 287;

		public const int HeroicisHead = 288;

		public const int HallowedCrown = 289;

		public const int LilacDuskHead = 290;

		public const int KazzymodusHood = 291;

		public const int LunasHead = 292;

		public static readonly int Count = 293;
	}
	...
	public class Body
	{
		public class Sets
		{
			...
			public static bool[] NeedsToDrawArm = Factory.CreateBoolSet(false, 200, 202, 201, 203, 195, 205, 207, 206, 228, 242, 243, 255, 256);
			...
			public static int[] IncludedCapeFront = Factory.CreateIntSet(-1, 184, 6, 248, 13);
			...
			public static bool[] HidesShouldersAsCoat = Factory.CreateBoolSet(251);

			public static bool[] showsShouldersWhileJumping = Factory.CreateBoolSet(177, 190, 95, 46, 73, 92, 24, 54, 55, 56, 65, 66, 67, 69, 70, 71, 75, 105, 106, 175, 176, 182, 183, 187, 194, 197, 198, 201, 204, 226, 227, 229, 239, 259);
		...
		public const int DeadCellsBeheadedBody = 248;

		public const int MoonLordBody = 249;

		public const int ChickenBonesBody = 250;

		public const int ChickenBonesRobe = 251;

		public const int UpgradedMiningBody = 252;

		public const int UpgradedFishingBody = 253;

		public const int ChippysBody = 254;

		public const int BlueBikiniBody = 255;

		public const int RedSwimsuitBody = 256;

		public const int HeroicisBody = 257;

		public const int LilacDuskBody = 258;

		public const int KazzymodusChestpiece = 259;

		public const int PalworldPalMetalArmorBody = 260;

		public const int LunasBody = 261;

		public static readonly int Count = 262;
	}
	...
	public class Legs
	{
		public class Sets
		{
			...
			public static bool[] DoesNotSupportSittingDraw = Factory.CreateBoolSet(195);
		}
		...
		public const int DeadCellsBeheadedLegsMale = 236;

		public const int ChickenBonesLegs = 237;

		public const int ChickenBonesRobeExtension = 238;

		public const int ChickenBonesRobeExtensionBack = 239;

		public const int UpgradedMiningLegs = 240;

		public const int UpgradedFishingLegs = 241;

		public const int ChippysLegs = 242;

		public const int BlueBikiniLegs = 243;

		public const int RedSwimsuitExtension = 244;

		public const int GreenSwimshorts = 245;

		public const int GraySwimshorts = 246;

		public const int HeroicisLegs = 247;

		public const int DeadCellsBeheadedLegsFemale = 248;

		public const int LilacDuskLegsMale = 249;

		public const int LilacDuskLegsFemale = 250;

		public const int KazzymodusLeggings = 251;

		public const int PalworldPalMetalArmorLegs = 252;

		public const int LunasLegs = 253;

		public static readonly int Count = 254;
	}
	...
	public class Back
	{
		public class Sets
		{
			...
			public static bool[] IsACape = Factory.CreateBoolSet(false, 1, 2, 3, 4, 5, 6, 14, 24, 34, 36, 39);
		}
		...
		public const sbyte ChickenBonesRobe = 37;

		public const sbyte ChippysWings = 38;

		public const sbyte LunasCloak = 39;

		public static readonly int Count = 40;
	}
	...
	public class Front
	{
		public class Sets
		{
			...
			public static bool[] DrawsInNeckLayerRegardlessOfPlayerFrame = Factory.CreateBoolSet(false, 13);

			public static bool[] DontDrawIfWearingAScarfOrCape = Factory.CreateBoolSet(false, 13);

			public static bool[] IsACape = Factory.CreateBoolSet(false, 1, 2, 3, 4, 5, 8, 11, 12, 16);

			public static bool[] HidesCompositeShoulders = Factory.CreateBoolSet(false, 8, 11, 15, 16);
		}
		...
		public const sbyte DeadCellsBeheadedBody = 13;

		public const sbyte ChickenBonesRobe = 14;

		public const sbyte ChippysWings = 15;

		public const sbyte LunasCloak = 16;
	...
	public class Shoe
	{
		public class Sets
		{
			...
			public static bool[] IsARollerSkate = Factory.CreateBoolSet(false, 27, 28, 29, 30);
		}
		...
		public const sbyte RollerSkates = 27;

		public const sbyte RollerSkatesGreen = 28;

		public const sbyte RollerSkatesWhite = 29;

		public const sbyte RollerSkatesPink = 30;

		public static readonly int Count = 31;
	}
	...
	public class Face
	{
		...
		public const sbyte WeldingMask = 22;

		public const sbyte ChippysHeadband = 23;

		public static readonly sbyte Count = 24;
	}
	...
	public class RocketBoots
	{
		...
		public const int RedsLeggings = 6;
	}
