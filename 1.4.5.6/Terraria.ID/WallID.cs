...
public class WallID
{
	...
	public const ushort Shimmerfall = 347;

	public const ushort FallenStarWall = 348;

	public const ushort StoneUnsafe = 349;

	public const ushort UnbreakableBlockWall = 350;

	public const ushort FeywoodWall = 351;

	public const ushort HallowedBrickWall = 352;

	public const ushort PineTreeBlockWall = 353;

	public const ushort EasterBlockWall = 354;

	public const ushort GothicBrickWall = 355;

	public const ushort FlinxFurBlockWall = 356;

	public const ushort JellyfishBlockWall = 357;

	public const ushort PineWoodBlockWall = 358;

	public const ushort HarpyBlockWall = 359;

	public const ushort MoonplateBlockWall = 360;

	public const ushort LibrarianBlockWall = 361;

	public const ushort SpikeBlockWall = 362;

	public const ushort OfficeBlockWall = 363;

	public const ushort ForbiddenBlockWall = 364;

	public const ushort WaterBlockWall = 365;

	public const ushort BoulderBlockWall = 366;

	public static readonly ushort Count = 367;
