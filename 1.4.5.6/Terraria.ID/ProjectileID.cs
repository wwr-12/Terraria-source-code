...
public class ProjectileID
{
	public static class Sets
	{
		...
		public static bool[] RocketsSkipDamageForPlayers = Factory.CreateBoolSet(338, 339, 340, 341, 803, 804, 862, 863, 805, 806, 807, 808, 809, 810, 930, 1088);

		public static bool[] IsABombWithFuse = Factory.CreateBoolSet(28, 37, 516, 519, 910, 911, 1086, 1087, 906, 905, 904, 903, 773, 1077, 75, 102, 681, 470, 29, 637);

		public static float[] YoyosLifeTimeMultiplier = Factory.CreateFloatSet(-1f, 541f, 3f, 548f, 5f, 542f, 7f, 543f, 6f, 544f, 8f, 534f, 9f, 564f, 11f, 999f, 11f, 545f, 13f, 563f, 30f, 562f, 16f, 553f, 12f, 546f, 16f, 552f, 15f, 549f, 14f);

		public static float[] YoyosMaximumRange = Factory.CreateFloatSet(200f, 541f, 130f, 548f, 170f, 542f, 195f, 543f, 207f, 544f, 215f, 534f, 220f, 564f, 225f, 999f, 225f, 545f, 235f, 562f, 235f, 563f, 250f, 546f, 275f, 552f, 270f, 553f, 330f, 547f, 280f, 549f, 290f, 554f, 340f, 550f, 370f, 551f, 370f, 555f, 360f, 603f, 400f);

		public static float[] YoyosTopSpeed = Factory.CreateFloatSet(10f, 541f, 9f, 548f, 11f, 542f, 12.5f, 543f, 12f, 544f, 13f, 534f, 13f, 564f, 14f, 999f, 14f, 545f, 14f, 562f, 17f, 563f, 12f, 546f, 15f, 552f, 14f, 553f, 15f, 547f, 17f, 549f, 16f, 554f, 16f, 550f, 16f, 551f, 16f, 555f, 16.5f, 603f, 17.5f);
		...
		public static bool[] MinionTargetingFeature = Factory.CreateBoolSet(191, 192, 193, 194, 266, 317, 373, 375, 387, 388, 390, 393, 407, 423, 533, 613, 625, 755, 758, 759, 831, 833, 834, 835, 864, 946, 951, 963, 970, 1022, 1093, 1094, 377, 308, 643, 641, 663, 665, 667, 677, 678, 679, 688, 689, 690, 691, 692, 693, 966, 1025);

		public static bool[] MinionSacrificable = Factory.CreateBoolSet(191, 192, 193, 194, 266, 317, 373, 375, 387, 388, 390, 393, 407, 423, 533, 613, 755, 758, 759, 831, 970, 864, 946, 951, 963, 1022, 1093, 1094, 625, 626, 627, 628);
	...
	public const short WebSlingerHook = 165;
	...
	public const short DeadCellsMushroomBoiMinion = 1022;

	public const short DeadCellsBarrel = 1023;

	public const short DeadCellsKillingDeckCard = 1024;

	public const short DeadCellsBarnacle = 1025;

	public const short DeadCellsBarnacleShot = 1026;

	public const short DeadCellsSwarmBiter = 1027;

	public const short CobWhip = 1028;

	public const short CorruptWhip = 1029;

	public const short CrimsonWhip = 1030;

	public const short MeteorWhip = 1031;

	public const short FlowerWhip = 1032;

	public const short EelWhip = 1033;

	public const short ConstellationWhip = 1034;

	public const short MoonLordWhip = 1035;

	public const short CobWhipSpider = 1036;

	public const short MeteorWhipMeteor = 1037;

	public const short FlowerWhipPetal = 1038;

	public const short ConstellationStar = 1039;

	public const short DeadCellsFlint = 1040;

	public const short DeadCellsFlintShot = 1041;

	public const short ShimmerGunStream = 1042;

	public const short DeadCellsFlintSlash = 1043;

	public const short DeadCellsMushroomBoiMinionExplosion = 1044;

	public const short MoonLordWhipProc = 1045;

	public const short Pufferfish = 1046;

	public const short RainbowBoulder = 1047;

	public const short Poulder = 1048;

	public const short MeteorStormMeteor = 1049;

	public const short AxeFairyPet = 1050;

	public const short SuperFertilizer = 1051;

	public const short Axearang = 1052;

	public const short LavaBoulder = 1053;

	public const short SpiderBoulder = 1054;

	public const short Ghoulder = 1055;

	public const short BoulderPet = 1056;

	public const short BoulderThatSpawnsPet = 1057;

	public const short FlaironFlail = 1058;

	public const short BluePhaseblade = 1059;

	public const short RedPhaseblade = 1060;

	public const short GreenPhaseblade = 1061;

	public const short PurplePhaseblade = 1062;

	public const short WhitePhaseblade = 1063;

	public const short YellowPhaseblade = 1064;

	public const short BluePhasesaber = 1065;

	public const short RedPhasesaber = 1066;

	public const short GreenPhasesaber = 1067;

	public const short PurplePhasesaber = 1068;

	public const short WhitePhasesaber = 1069;

	public const short YellowPhasesaber = 1070;

	public const short OrangePhaseblade = 1071;

	public const short OrangePhasesaber = 1072;

	public const short PoisonDartShotFromSlimes = 1073;

	public const short Keybrand = 1074;

	public const short PinkPhaseblade = 1075;

	public const short PinkPhasesaber = 1076;

	public const short FreezeBomb = 1077;

	public const short MeteorOre = 1078;

	public const short PinkCounterweight = 1079;

	public const short BirdDroppings = 1080;

	public const short MudBallPlayer = 1081;

	public const short AntlionClaw = 1082;

	public const short StylistKilLaKillScissorsIWish = 1083;

	public const short TorchGodHelper = 1084;

	public const short PrettyMirror = 1085;

	public const short SuperBomb = 1086;

	public const short SuperStickyBomb = 1087;

	public const short AcornSlingshotAcorn = 1088;

	public const short RainbowGlowstick = 1089;

	public const short RainbowBoulderPet = 1090;

	public const short StormLightning = 1091;

	public const short LibrarianSkeletonBook = 1092;

	public const short PalworldMinionCattiva = 1093;

	public const short PalworldMinionFoxsparks = 1094;

	public const short PalworldPetChillet = 1095;

	public const short PalworldPetChilletIgnis = 1096;

	public const short PalworldMinionFoxsparksFireball = 1097;

	public const short PalworldDigtoise = 1098;

	public const short SoundGun = 1099;

	public const short TrueCopperShortsword = 1100;

	public const short RainbowPhaseblade = 1101;

	public const short RainbowPhasesaber = 1102;

	public const short SlimeSpear = 1103;

	public const short SlimeWhip = 1104;

	public const short RemoteControlCar = 1105;

	public const short PalworldMinionFoxsparksFlames = 1106;

	public const short ObsidianFire = 1107;

	public const short ObsidianFire2 = 1108;

	public const short ObsidianFire3 = 1109;

	public const short SkyDragonsFuryElectrosphere = 1110;

	public static readonly short Count = 1111;
