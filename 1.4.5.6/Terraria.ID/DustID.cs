...
public static class DustID
{
	...
	public const short UnderwaterBubble = 34;
	...
	public const short JesterSparkleYellow = 57;

	public const short PinkStarfury = 58;
	...
	public const short ShimmerStream = 324;

	public const short PinkPhaseblade = 325;

	public const short LavaCloud = 326;

	public const short StarCloud = 327;

	public const short RainbowCloud = 328;

	public const short BirdDroppings = 329;

	public const short PrettyMirror = 330;

	public static readonly short Count = 331;
