...
public class UISlicedImage : UIElement
{
	...
	protected override void DrawSelf(SpriteBatch spriteBatch)
	{
		...
		Utils.DrawSplicedPanel(spriteBatch, _texture.Value, (int)dimensions.X, (int)dimensions.Y, (int)dimensions.Width, (int)dimensions.Height, _leftSliceDepth, _rightSliceDepth, _topSliceDepth, _bottomSliceDepth, _color);
	}
