	...
	public class AchievementUnlockedPopup : IInGameNotification
	{
		...
		public void DrawInGame(SpriteBatch sb, Vector2 bottomAnchorPosition)
		{
			...
			if (opacity > 0f)
			{
				...
				sb.Draw(_achievementBorderTexture.Value, vector, null, Color.White * opacity, 0f, new Vector2(4f, _achievementBorderTexture.Height() / 2), num3, SpriteEffects.None, 0f);
