	...
	internal class UITextBox : UITextPanel<string>
	{
		...
		protected override void DrawSelf(SpriteBatch spriteBatch)
		{
			...
			if ((_frameCount %= 40) <= 20)
			{
				...
				Vector2 vector = new Vector2((base.IsLarge ? Main.fontDeathText : Main.fontMouseText).MeasureString(base.Text.Substring(0, _cursor)).X, base.IsLarge ? 32f : 16f) * base.TextScale;
				if (base.IsLarge)
				{
