...
namespace Terraria.Social.Steam
{
	public class Lobby
	{
		...
		public Lobby()
		{
			...
			_lobbyEnter = CallResult<LobbyEnter_t>.Create(new CallResult<LobbyEnter_t>.APIDispatchDelegate(OnLobbyEntered));
			_lobbyCreated = CallResult<LobbyCreated_t>.Create(new CallResult<LobbyCreated_t>.APIDispatchDelegate(OnLobbyCreated));
		}
		...
		public void Create(bool inviteOnly, APIDispatchDelegate<LobbyCreated_t> callResult)
		{
			...
			SteamAPICall_t val = SteamMatchmaking.CreateLobby(inviteOnly ? ELobbyType.k_ELobbyTypePrivate : ELobbyType.k_ELobbyTypePublic, 256);
