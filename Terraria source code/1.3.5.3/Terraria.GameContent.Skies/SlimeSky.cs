...
namespace Terraria.GameContent.Skies
{
	public class SlimeSky : CustomSky
	{
		...
		public override void OnLoad()
		{
			...
			for (int i = 0; i < 4; i++)
			{
				_textures[i] = TextureManager.Load("Images/Misc/Sky_Slime_" + (i + 1));
			}
			GenerateSlimes();
		}
