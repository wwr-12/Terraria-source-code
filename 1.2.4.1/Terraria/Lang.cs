namespace Terraria
{
	public class Lang
	{
		...
		public static string dialog(int l, bool english = false)
		{
			...
			string text2 = NPC.firstNPCName(17);
			string text3 = NPC.firstNPCName(19);
			string text4 = NPC.firstNPCName(20);
			string text5 = NPC.firstNPCName(38);
			string text6 = NPC.firstNPCName(54);
			string text7 = NPC.firstNPCName(22);
			NPC.firstNPCName(108);
			string text8 = NPC.firstNPCName(107);
			string text9 = NPC.firstNPCName(124);
			string text10 = NPC.firstNPCName(160);
			NPC.firstNPCName(178);
			NPC.firstNPCName(207);
			string text11 = NPC.firstNPCName(208);
			string text12 = NPC.firstNPCName(209);
			NPC.firstNPCName(227);
			NPC.firstNPCName(228);
			string text13 = NPC.firstNPCName(229);
			string text14 = NPC.firstNPCName(353);
			NPC.firstNPCName(368);
			string text15 = NPC.firstNPCName(369);
			if (lang <= 1 || english)
			{
				switch (l)
				{
				...
				case 13:
					return "Oh, great. I can hear " + text9 + " and " + text + " arguing from here.";
				case 14:
				...
				case 33:
					return "I wish " + text5 + " would be more careful.  I'm getting tired of having to sew his limbs back on every day.";
				case 34:
					return "Hey, has " + text3 + " mentioned needing to go to the doctor for any reason? Just wondering.";
				case 35:
					return "I need to have a serious talk with " + text7 + ". How many times a week can you come in with severe lava burns?";
				case 36:
				...
				case 58:
					return "I heard there is a doll that looks very similar to " + text7 + " somewhere in the underworld.  I'd like to put a few rounds in it.";
				case 59:
				...
				case 61:
					return text4 + " is a looker.  Too bad she's such a prude.";
				case 62:
					return "Don't bother with " + text5 + ", I've got all you need right here.";
				case 63:
					return "What's " + text5 + "'s problem? Does he even realize we sell completely different stuff?";
				case 64:
				...
				case 70:
					return "I wish " + text3 + " would stop flirting with me. Doesn't he realize I'm 500 years old?";
				case 71:
					return "Why does " + text2 + " keep trying to sell me an angel statues? Everyone knows that they don't do anything.";
				case 72:
				...
				case 238:
					return "I feel like " + text10 + " is a bit misunderstood, he really is a fun guy.";
				case 82:
				...
				case 97:
					return "Even " + text3 + " wants what I'm selling!";
				case 98:
				...
				case 237:
					return "I'll give you a discount on your wears if you can convince " + text10 + " to come over for a...sizing.";
				case 120:
				...
				case 126:
					return "Hey...what's " + text9 + " up to? Have you...have you talked to her, by chance?";
				case 127:
				...
				case 146:
					return "Well, hi there, " + text9 + "! What can I do for you today?";
				case 147:
				...
				case 165:
					return "Hey, " + Main.player[Main.myPlayer].name + ", did you just come from " + text8 + "'s? Did he say anything about me by chance?";
				case 166:
					return text3 + " keeps talking about pressing my pressure plate. I told him it was for stepping on.";
				case 167:
				...
				case 232:
					return "Between you and me, " + text4 + " is the only one I trust. She is the only one here who hasn't tried to eat me or use me in a potion.";
				case 233:
				...
				case 246:
					return "I'm mighty curious about that " + text12 + " fellow. By what manner of consumption does he maintain such locomotion?";
				case 247:
				...
				case 251:
					return "Check out " + text11 + ". Now that's a girl who can paint the town red!";
				case 252:
				...
				case 260:
					return "You must do something about " + text13 + ".  Everytime he comes over here, it takes me a week to get the smell off!";
				case 261:
				...
				case 271:
					return "My name's " + text11 + " but people call me party pooper. Yeah I don't know, it sounds cool though.";
				case 272:
				...
				case 284:
					return "Sure, me and " + text13 + " are pals, but I hate it when his parrot does his business on me. That stuff's corrosive!";
				case 285:
				...
				case 300:
					return "Hello sir, I'm " + text14 + ", and I'll be your barber today.";
				case 301:
					return "Just a little off the top?  That's no fun...";
				case 302:
					return "I hope you like what I did to " + text11 + "'s hair!";
				case 303:
					return "There is nothing I can do for " + text5 + "'s singed head. He's a lost cause.";
				case 304:
				...
				case 307:
					return "Mhmm, I heard from " + text11 + " that " + text9 + "'s friend " + text + " spent her boyfriend's last paycheck on shoes.";
				case 308:
					return "One time I put a wig on " + text12 + " just so I could cut his hair. I think he kinda liked it!";
				case 311:
				...
				case 309:
					return "I tried to visit " + text14 + " one time. She just looked at me and said 'nope.'";
				case 310:
					return "I think it is about time I got my hair did!";
				case 319:
					return "Meet me behind " + text7 + "'s house in about three hours, I think I have something you will find very appealing.";
				case 320:
					return "That " + text2 + ", he really has no appreciation for a really good deal.";
				case 321:
					return "I sell only what I can get. " + text6 + " keeps hounding me for exotic clothing.";
				case 322:
				...
				case 337:
					return text15 + " wants YOU as the official " + Main.worldName + " errand monkey!";
				case 338:
				...
				case 347:
					return "Heh heh, you shoulda seen the look on " + text4 + "'s face when I stuck that piranha tooth in the chair!";
				case 348:
			...
			else if (lang == 2)
			{
				...
				case 13:
					return "Toll. Ich kann " + text9 + " und " + text + " von hier aus diskutieren hoeren.";
				case 14:
				...
				case 33:
					return "Ich wuenschte, " + text5 + " waere vorsichtiger. Es nervt mich, taeglich seine Glieder zusammennaehen zu muessen.";
				case 34:
					return "Heh, hat " + text3 + " den Grund fuer einen notwendigen Arztbesuch erwaehnt? Ich wundere mich nur.";
				case 35:
					return "Ich muss mal ein ernsthaftes Wort mit  " + text7 + " reden. Wie oft kann man in einer Woche mit schweren Lava-Verbrennungen hereinkommen?";
				case 36:
				...
				case 58:
					return "Ich habe gehoert, es gibt eine Puppe in der Unterwelt, die " + text7 + " sehr aehnlich sieht. Ich wuerde gern ein bisschen schiessen.";
				case 59:
				...
				case 61:
					return text4 + " ist ein Huebscher. Zu dumm, dass sie so pruede ist.";
				case 62:
					return "Halte dich nicht mit " + text5 + " auf, ich habe alles, was du brauchst hier.";
				case 63:
					return "Was ist eigentlich mit " + text5 + " los? Kriegt der mal mit, dass wir ganz andere Sachen verkaufen?";
				case 64:
				...
				case 70:
					return "Ich wuenschte,  " + text3 + " wuerde die Flirterei lassen. Versteht er nicht, dass ich 500 Jahre alt bin?";
				case 71:
					return "Warum versucht " + text2 + " , mir Engelsstatuen zu verkaufen? Jeder weiss, dass sie nutzlos sind.";
				case 72:
				...
				case 97:
					return "Sogar " + text3 + " ist scharf auf meine Waren!";
				case 98:
				...
				case 126:
					return "Heh ... was macht " + text9 + " so? Hast du ... hast du vielleicht mit ihr gesprochen?";
				case 127:
				...
				case 142:
					return "Hallo, " + text7 + "! Was kann ich heute fuer dich tun?";
				case 143:
					return "Hallo, " + text5 + "! Was kann ich heute fuer dich tun?";
				case 144:
					return "Hallo, " + text8 + "! Was kann ich heute fuer dich tun?";
				case 145:
					return "Hallo, " + text + "! Was kann ich heute fuer dich tun?";
				case 146:
					return "Hallo, " + text9 + "! Was kann ich heute fuer dich tun?";
				case 147:
				...
				case 165:
					return "Sag, " + Main.player[Main.myPlayer].name + ", kommst du gerade von " + text8 + "? Hat er vielleicht etwas ueber mich gesagt?";
				case 166:
					return text3 + " spricht immer davon, auf meine Druckplatten zu druecken. Ich habe ihm gesagt, die ist zum Drauftreten.";
				case 167:
				...
				case 238:
					return "Ich fühle mich wie " + text10 + " ein wenig missverstanden wird, er ist wirklich ein lustiger Kerl.";
				case 237:
					return "Ich gebe Ihnen einen Rabatt auf Ihre trägt, wenn Sie " + text10 + " überzeugen können, zu kommen für eine ... Sizing.";
				case 231:
				...
				case 232:
					return "Zwischen Ihnen und mir, " + text4 + " ist der einzige, der ich vertraue. Sie ist die einzige hier, die nicht versucht hat, mich zu essen oder benutzen Sie mich in einem Trank.";
				case 233:
				...
				case 246:
					return "Ich bin mächtig neugierig auf dieser " + text12 + " Kerl. Durch welche Art und Weise der Verbrauch hat er beibehalten, wie Fortbewegung?";
				case 247:
				...
				case 251:
					return "Schauen Sie sich " + text11 + ". Nun, das ist ein Mädchen, das die Stadt rot malen kann!";
				case 252:
				...
				case 260:
					return "Sie müssen etwas über " + text13 + " zu tun.  Jedes Mal, wenn er kommt hierher, dauert es mir eine Woche, um den Geruch zu steigen!";
				case 261:
				...
				case 271:
					return "Mein Name ist " + text11 + " aber die Leute nennen mich Partei Popper. Ja, ich weiß es nicht, es klingt aber kühl";
				case 272:
				...
				case 284:
					return "Sicher, mir und " + text13 + " sind Kumpels, aber ich hasse es, wenn seinem Papagei macht sein Geschäft auf mich. Das Zeug ist ätzend!";
				case 285:
			...
			else if (lang == 3)
			{
				...
				case 13:
					return "Fantastico. Sento " + text9 + " e " + text + " discutere da qui.";
				case 14:
				...
				case 33:
					return "Vorrei che " + text5 + " fosse più attento.  Mi sto stancando di dovergli ricucire gli arti ogni giorno.";
				case 34:
					return "Ehi, " + text3 + " ha detto di dover andare dal dottore per qualche ragione? Solo per chiedere.";
				case 35:
					return "Devo parlare seriamente con " + text7 + ". Quante volte a settimana si può venire con gravi ustioni da lava?";
				case 36:
				...
				case 58:
					return "Ho sentito che c'è una bambola molto simile a " + text7 + " nel sottomondo. Vorrei metterci dei proiettili.";
				case 59:
					return "Veloce! Ho un appuntamento con " + text + " tra un'ora.";
				case 60:
					return "Voglio quello che vende " + text + ". In che senso, non vende niente?";
				case 61:
					return text4 + " è uno spettacolo. Peccato sia così bigotta.";
				case 62:
					return "Lascia stare " + text5 + ", ho tutto ciò che ti serve qui.";
				case 63:
					return "Qual è il problema di " + text5 + "? Almeno lo sa che vendiamo oggetti diversi?";
				case 64:
				...
				case 70:
					return "Vorrei che " + text3 + " la smettesse di flirtare con me. Non sa che ho 500 anni?";
				case 71:
					return "Perché " + text2 + " continua a vendermi statue d'angelo? Lo sanno tutti che non servono a nulla.";
				case 72:
				...
				case 97:
					return "Persino " + text3 + " vuole ciò che sto vendendo!";
				case 98:
				...
				case 126:
					return "Ehi... cosa sta combinando " + text9 + "? Hai... hai parlato con lei, per caso?";
				case 127:
				...
				case 146:
					return "Bene, ciao, " + text9 + "! Cosa posso fare per te oggi?";
				case 147:
				...
				case 165:
					return "Ehi, " + Main.player[Main.myPlayer].name + ", sei appena stato da " + text8 + "? Ha detto qualcosa di me, per caso?";
				case 166:
					return text3 + " continua a dire di aver schiacciato la mia piastra a pressione. Gli ho spiegato che serve proprio a quello.";
				case 167:
				...
				case 238:
					return "Mi sento come " + text10 + " è un po 'incompreso, lui è davvero un tipo divertente.";
				case 237:
					return "Ti darò uno sconto sul tuo capo se si può convincere " + text10 + " di venire per un ... dimensionamento.";
				case 231:
					return "Come se vivere sottoterra non bastasse, cretini come si arriva in mentre dormo e rubato i miei figli.";
				case 232:
					return "Tra me e te, " + text4 + " è l'unico di cui mi fido. Lei è l'unico qui che non ha cercato di mangiare me o utilizzare in una pozione.";
				case 233:
				...
				case 246:
					return "Sono possente curioso di quel " + text12 + " compagno. Con che tipo di consumo fa a mantenere tale locomozione?";
				case 247:
				...
				case 251:
					return "Scopri " + text11 + ". Ora che è una ragazza che può dipingere di rosso la città!";
				case 252:
				...
				case 260:
					return "Devi fare qualcosa per " + text13 + ".  Ogni volta che viene qui, mi ci vuole una settimana per ottenere l'odore di sconto!";
				case 261:
				...
				case 271:
					return "Il mio nome di " + text11 + " ma le persone mi chiamano partito popper. Si. Non lo so, suona freddo comunque.";
				case 272:
				...
				case 284:
					return "Certo, io e " + text13 + " sono amici, ma odio quando il suo pappagallo fa il suo lavoro su di me. Corrosiva che roba!";
				case 285:
			...
			else if (lang == 4)
			{
				...
				case 13:
					return "Oh, génial ! J'entends " + text9 + " et " + text + " se disputer d'ici.";
				case 14:
				...
				case 33:
					return "J'aimerais bien que " + text5 + " fasse plus attention. J'en ai assez de lui faire des points de suture chaque jour.";
				case 34:
					return "Je me demande si " + text3 + " a dit qu'il avait besoin d'un docteur.";
				case 35:
					return "Il va falloir que je discute sérieusement avec " + text7 + ". Combien de fois par semaine allez-vous revenir ici avec des brûlures au second degré ?";
				case 36:
				...
				case 58:
					return "J'ai entendu dire qu'il y aurait une poupée qui ressemblerait beaucoup à " + text7 + " dans le monde inférieur. J'aimerais bien lui coller quelques pruneaux.";
				case 59:
				...
				case 61:
					return text4 + " est vraiment canon. Dommage qu'elle soit aussi prude.";
				case 62:
					return "Ne vous embêtez pas avec " + text5 + ", j'ai tout ce qu'il vous faut ici.";
				case 63:
					return "C'est quoi le problème de " + text5 + " ? Est-ce qu'il réalise seulement que l'on vend du matériel complètement différent ?";
				case 64:
				...
				case 70:
					return "Ce serait bien si " + text3 + " cessait de me courtiser. J'ai quand même 500 ans, mais ça n'a pas l'air de lui faire peur.";
				case 71:
					return "Pourquoi " + text2 + " essaie-t-il toujours de me vendre des statues d'ange ? Tout le monde sait qu'elles sont sans intérêt.";
				case 72:
				...
				case 97:
					return "Même " + text3 + " raffole de mes marchandises.";
				case 98:
				...
				case 126:
					return "Et comment va " + text9 + "? Lui auriez-vous parlé, par hasard ?";
				case 127:
				...
				case 146:
					return "Bonjour, " + text9 + "! Que puis-je pour vous, aujourd'hui ?";
				case 147:
				...
				case 165:
					return "Au fait, " + Main.player[Main.myPlayer].name + ", vous venez de voir  " + text8 + " ? Est-ce qu'il aurait parlé de moi, par hasard ?";
				case 166:
					return text3 + " parle toujours de pressuriser mes plaques de pression. Je lui ai dit que c'était pour marcher dessus.";
				case 167:
				...
				case 238:
					return "Je me sens comme " + text10 + " est un peu mal compris, il est vraiment un gars amusant.";
				case 237:
					return "Je vais vous donner un rabais sur votre usures si vous pouvez convaincre " + text10 + " à venir pour un ... dimensionnement.";
				case 231:
					return "Comme si vivre souterrain n'était pas assez, saccades comme vous venez pendant que je dors et volé mes enfants.";
				case 232:
					return "Entre vous et moi, " + text4 + " est le seul en qui j'ai confiance. Elle est la seule personne ici qui n'a pas essayé de me manger ou m'utiliser dans une potion.";
				case 233:
				...
				case 246:
					return "Je suis curieux de savoir ce puissant " + text12 + " camarade. Par ce mode de consommation-t-il maintenir cette locomotion?";
				case 247:
				...
				case 251:
					return "Découvrez " + text11 + ". Maintenant, c'est une fille qui peut peindre la ville rouge!";
				case 252:
				...
				case 260:
					return "Vous devez faire quelque chose pour " + text13 + ".  Chaque fois qu'il vient ici, il me faut une semaine pour obtenir l'odeur off!";
				case 261:
				...
				case 271:
					return "Je m'appelle " + text11 + " mais les gens m'appellent Party Pooper. Ouais, je ne sais pas, c'est assez cool si";
				case 272:
				...
				case 284:
					return "Bien sûr, " + text13 + " et moi sommes copains, mais je déteste quand son perroquet fait ses affaires sur moi. Le corrosif de ce genre de choses!";
				case 285:
			...
			else if (lang == 5)
			{
				...
				case 13:
					return "¡Vaya! Desde aquí se oye cómo discuten " + text9 + " y " + text + ".";
				case 14:
				...
				case 33:
					return "Ojalá " + text5 + " tuviera más cuidado. Ya me estoy hartando de tener que coserle las extremidades todos los días.";
				case 34:
					return "Oye, por curiosidad, ¿ha dicho " + text3 + " por qué tiene que ir al médico?";
				case 35:
					return "Debo hablar en serio con " + text7 + ". ¿Cuántas veces crees que puedes venir en una semana con quemaduras de lava graves?";
				case 36:
				...
				case 58:
					return "Dicen que en alguna parte del Inframundo hay una muñeca que se parece mucho a" + text7 + " Me gustaría dejarme caer por ahí.";
				case 59:
					return "¡Date prisa! Tengo una cita con " + text + " dentro de una hora.";
				case 60:
					return "Quiero lo que vende " + text + ". ¿Cómo dices? ¿Que no vende nada?";
				case 61:
					return text4 + " es una monada. Es una lástima que sea tan mojigata.";
				case 62:
					return "Olvídate de " + text5 + ", yo tengo todo lo que necesitas aquí y ahora.";
				case 63:
					return "¿Qué mosca le ha picado a " + text5 + "? ¿Aún no sabe que vendemos cosas totalmente distintas?";
				case 64:
				...
				case 70:
					return "Ojalá " + text3 + " dejara de flirtear conmigo. ¿No se da cuenta de que tengo 500 años?";
				case 71:
					return "¿Por qué se empeña " + text2 + " en intentar venderme una estatua de ángel? Todo el mundo sabe que no hacen nada.";
				case 72:
				...
				case 97:
					return "¡Incluso " + text3 + " quiere lo que vendo!";
				case 98:
				...
				case 126:
					return "Oye... ¿Qué trama " + text9 + "? ¿Tú... has hablado con ella, por un casual?";
				case 127:
				...
				case 146:
					return "¡Eh, hola, " + text9 + "! ¿Qué puedo hacer hoy por ti?";
				case 147:
				...
				case 165:
					return "Eh, " + Main.player[Main.myPlayer].name + "¿acabas de llegar de la casa de " + text8 + "? ¿Por casualidad no te hablaría de mí?";
				case 166:
					return text3 + " sigue insistiendo en pulir mi chapa de presión. Ya le he dicho que funciona pisándola.";
				case 167:
				...
				case 238:
					return "Me siento como " + text10 + " es un poco incomprendido, que realmente es un tipo divertido.";
				case 237:
					return "Te voy a dar un descuento en su desgastes si se puede convencer a " + text10 + " venir a un ... tamaño.";
				case 231:
					return "Como si vivir bajo tierra no fuera suficientemente malo, idiotas como tú vienes mientras duermo y robar mis hijos.";
				case 232:
					return "Entre tú y yo, " + text4 + " es el único en quien confío. Ella es el único aquí que no se ha probado a comer o me utilice en una poción.";
				case 233:
				...
				case 246:
					return "Estoy muy curioso acerca de ese tipo " + text12 + ". ¿Con qué tipo de consumo no se mantiene como la locomoción?";
				case 247:
				...
				case 251:
					return "Echa un vistazo a " + text11 + ". Eso sí que es una chica que es capaz de pintar la ciudad de rojo!";
				case 252:
				...
				case 260:
					return "Tienes que hacer algo con " + text13 + ".  Cada vez que venga por aquí, me lleva una semana para conseguir el olor de descuento!";
				case 261:
				...
				case 271:
					return "Mi nombre es " + text11 + " pero la gente me llama partido popper. Sí. No sé, suena guay";
				case 272:
				...
				case 284:
					return "Claro, " + text13 + " y yo somos amigos, pero no me gusta cuando su loro hace su negocio en mí. Corrosiva es esa cosa!";
				case 285:
		...
		public static void tTip()
		{
			for (int i = 1; i < 2749; i++)
			{
				...
				{
					string text = "case " + i + ": return \"" + item.toolTip2 + "\";";
				}
			}
		}
		...
		public static string AnglerQuestChat(bool gotFish = false)
		{
			...
			NPC.firstNPCName(368);
			string text = NPC.firstNPCName(369);
			int num = 8;
			...
			if (Main.anglerQuestFinished)
			{
				...
				case 1:
					...
					break;
				case 2:
					array[0] = "You are done, the grand " + text + " dismisses you!";
					break;
				case 3:
			...
			else
			{
				...
				case 2470:
					...
					array[num2++] = "The fish, however, do! A fish made out of ice would make a great offering to the mighty and amazing " + text + "!";
		...
		public static void setLang(bool english = false)
		{
			...
			if (lang <= 1 || english)
			{
				...
				misc[18] = "has arrived!";
				misc[19] = " was slain...";
				misc[20] = "A solar eclipse is happening!";
				misc[21] = "Your world has been blessed with Palladium!";
				misc[22] = "Your world has been blessed with Orichalcum!";
				misc[23] = "Your world has been blessed with Titanium!";
				misc[24] = "The pirates have been defeated!";
				misc[25] = "Pirates are approaching from the west!";
				misc[26] = "Pirates are approaching from the east!";
				misc[27] = "The pirates have arrived!";
				misc[28] = "You feel vibrations from deep below...";
				misc[29] = "This is going to be a terrible night...";
				misc[30] = "The air is getting colder around you...";
				misc[31] = "The Pumpkin Moon is rising...";
				misc[32] = "The jungle grows restless...";
				misc[33] = "Screams are echoing from the dungeon...";
				misc[34] = "The Frost Moon is rising...";
				misc[35] = "has departed!";
				misc[36] = " has left!";
				misc[37] = "Any";
				misc[38] = "Pressure Plate";
				...
				menu[51] = "Resolution";
				menu[52] = "Parallax";
				menu[53] = "Frame Skip Off";
				menu[54] = "Frame Skip On";
				...
				menu[104] = "Yes";
				menu[105] = "No";
				menu[106] = "Toggle Map Style           ";
				menu[107] = "Toggle Fullscreen           ";
				menu[108] = "Zoom In                      ";
				menu[109] = "Zoom Out                    ";
				menu[110] = "Decrease Transparency     ";
				menu[111] = "Increase Transparency      ";
				menu[112] = "Map Enabled";
				menu[113] = "Map Disabled";
				menu[114] = "General";
				menu[115] = "Map Controls";
				menu[116] = "Multicore Lighting:";
				menu[117] = "Off";
				menu[118] = "Close Menu";
				menu[119] = "Ambient";
				menu[120] = "Smart Cursor   ";
				menu[121] = "Smart Cursor Mode: Toggle";
				menu[122] = "Smart Cursor Mode: Hold";
				...
				gen[60] = "Smoothing the world:";
				gen[61] = "Mossification:";
				gen[62] = "Gemification:";
				gen[63] = "Making cave walls:";
				gen[64] = "Growing spider caves:";
				gen[65] = "Clearing map data:";
				gen[66] = "Saving map data:";
				gen[67] = "Loading map data:";
				gen[68] = "Drawing map:";
				gen[69] = "Creating waterfalls:";
				gen[70] = "Creating jungle ruins...";
				gen[71] = "Creating hornet nests...";
				gen[72] = "Making the world bloody:";
				gen[73] = "Validating world save:";
				inter[0] = "Life:";
				inter[1] = "Breath";
				inter[2] = "Mana";
				inter[3] = "Trash Can";
				...
				inter[53] = "Water";
				inter[54] = "Heal";
				inter[55] = "This housing does not meet the requirements for a";
				inter[56] = "Lava";
				inter[57] = "Dye";
				inter[58] = "Honey";
				inter[59] = "Accessory visible";
				inter[60] = "Accessory hidden";
				inter[61] = "Rename";
				inter[62] = "Settings";
				inter[63] = "Cancel";
				inter[64] = "Quest";
				...
				if (mapLegend == null)
				{
					mapLegend = new string[Map.colorLookup.Length];
				}
				mapLegend[Map.TileToLookup(4, 0)] = "Torch";
				mapLegend[Map.TileToLookup(4, 1)] = "Torch";
				mapLegend[Map.TileToLookup(5, 0)] = "Tree";
				mapLegend[Map.TileToLookup(6, 0)] = "Iron";
				mapLegend[Map.TileToLookup(7, 0)] = "Copper";
				mapLegend[Map.TileToLookup(8, 0)] = "Gold";
				mapLegend[Map.TileToLookup(9, 0)] = "Silver";
				mapLegend[Map.TileToLookup(10, 0)] = "Door";
				mapLegend[Map.TileToLookup(11, 0)] = "Door";
				mapLegend[Map.TileToLookup(12, 0)] = "Heart Crystal";
				mapLegend[Map.TileToLookup(13, 0)] = "Bottle";
				mapLegend[Map.TileToLookup(14, 0)] = "Table";
				mapLegend[Map.TileToLookup(15, 0)] = "Chair";
				mapLegend[Map.TileToLookup(16, 0)] = "Anvil";
				mapLegend[Map.TileToLookup(17, 0)] = "Furnace";
				mapLegend[Map.TileToLookup(18, 0)] = "Work Bench";
				mapLegend[Map.TileToLookup(20, 0)] = "Sapling";
				mapLegend[Map.TileToLookup(21, 0)] = "Chest";
				mapLegend[Map.TileToLookup(22, 0)] = "Demonite";
				mapLegend[Map.TileToLookup(26, 0)] = "Demon Altar";
				mapLegend[Map.TileToLookup(26, 1)] = "Crimson Altar";
				mapLegend[Map.TileToLookup(27, 0)] = Main.itemName[63];
				mapLegend[Map.TileToLookup(28, 0)] = "Pot";
				mapLegend[Map.TileToLookup(29, 0)] = Main.itemName[87];
				mapLegend[Map.TileToLookup(31, 0)] = "Shadow Orb";
				mapLegend[Map.TileToLookup(31, 1)] = "Crimson Heart";
				mapLegend[Map.TileToLookup(32, 0)] = "Thorns";
				mapLegend[Map.TileToLookup(33, 0)] = "Candle";
				mapLegend[Map.TileToLookup(34, 0)] = "Chandelier";
				mapLegend[Map.TileToLookup(35, 0)] = "Jack 'O Lantern";
				mapLegend[Map.TileToLookup(36, 0)] = "Present";
				mapLegend[Map.TileToLookup(42, 0)] = "Lantern";
				mapLegend[Map.TileToLookup(48, 0)] = "Spike";
				mapLegend[Map.TileToLookup(49, 0)] = Main.itemName[148];
				mapLegend[Map.TileToLookup(50, 0)] = "Book";
				mapLegend[Map.TileToLookup(51, 0)] = "Web";
				mapLegend[Map.TileToLookup(55, 0)] = "Sign";
				mapLegend[Map.TileToLookup(63, 0)] = "Sapphire";
				mapLegend[Map.TileToLookup(64, 0)] = "Ruby";
				mapLegend[Map.TileToLookup(65, 0)] = "Emerald";
				mapLegend[Map.TileToLookup(66, 0)] = "Topaz";
				mapLegend[Map.TileToLookup(67, 0)] = "Amethyst";
				mapLegend[Map.TileToLookup(68, 0)] = "Diamond";
				mapLegend[Map.TileToLookup(69, 0)] = "Thorn";
				mapLegend[Map.TileToLookup(72, 0)] = "Giant Mushroom";
				mapLegend[Map.TileToLookup(77, 0)] = "Hellforge";
				mapLegend[Map.TileToLookup(78, 0)] = "Clay Pot";
				mapLegend[Map.TileToLookup(79, 0)] = "Bed";
				mapLegend[Map.TileToLookup(80, 0)] = "Cactus";
				mapLegend[Map.TileToLookup(81, 0)] = "Coral";
				mapLegend[Map.TileToLookup(82, 0)] = Main.itemName[313];
				mapLegend[Map.TileToLookup(82, 1)] = Main.itemName[314];
				mapLegend[Map.TileToLookup(82, 2)] = Main.itemName[315];
				mapLegend[Map.TileToLookup(82, 3)] = Main.itemName[316];
				mapLegend[Map.TileToLookup(82, 4)] = Main.itemName[317];
				mapLegend[Map.TileToLookup(82, 5)] = Main.itemName[318];
				mapLegend[Map.TileToLookup(82, 6)] = Main.itemName[2358];
				mapLegend[Map.TileToLookup(83, 0)] = Main.itemName[313];
				mapLegend[Map.TileToLookup(83, 1)] = Main.itemName[314];
				mapLegend[Map.TileToLookup(83, 2)] = Main.itemName[315];
				mapLegend[Map.TileToLookup(83, 3)] = Main.itemName[316];
				mapLegend[Map.TileToLookup(83, 4)] = Main.itemName[317];
				mapLegend[Map.TileToLookup(83, 5)] = Main.itemName[318];
				mapLegend[Map.TileToLookup(83, 6)] = Main.itemName[2358];
				mapLegend[Map.TileToLookup(84, 0)] = Main.itemName[313];
				mapLegend[Map.TileToLookup(84, 1)] = Main.itemName[314];
				mapLegend[Map.TileToLookup(84, 2)] = Main.itemName[315];
				mapLegend[Map.TileToLookup(84, 3)] = Main.itemName[316];
				mapLegend[Map.TileToLookup(84, 4)] = Main.itemName[317];
				mapLegend[Map.TileToLookup(84, 5)] = Main.itemName[318];
				mapLegend[Map.TileToLookup(84, 6)] = Main.itemName[2358];
				mapLegend[Map.TileToLookup(85, 0)] = "Tombstone";
				mapLegend[Map.TileToLookup(86, 0)] = "Loom";
				mapLegend[Map.TileToLookup(87, 0)] = "Piano";
				mapLegend[Map.TileToLookup(88, 0)] = "Dresser";
				mapLegend[Map.TileToLookup(89, 0)] = "Bench";
				mapLegend[Map.TileToLookup(90, 0)] = "Bathtub";
				mapLegend[Map.TileToLookup(91, 0)] = "Banner";
				mapLegend[Map.TileToLookup(92, 0)] = "Lamp Post";
				mapLegend[Map.TileToLookup(93, 0)] = "Floor Lamp";
				mapLegend[Map.TileToLookup(94, 0)] = "Keg";
				mapLegend[Map.TileToLookup(95, 0)] = "Chinese Lantern";
				mapLegend[Map.TileToLookup(96, 0)] = "Cooking Pot";
				mapLegend[Map.TileToLookup(97, 0)] = "Safe";
				mapLegend[Map.TileToLookup(98, 0)] = "Skull Lantern";
				mapLegend[Map.TileToLookup(100, 0)] = "Candelabra";
				mapLegend[Map.TileToLookup(101, 0)] = "Bookcase";
				mapLegend[Map.TileToLookup(102, 0)] = "Throne";
				mapLegend[Map.TileToLookup(103, 0)] = "Bowl";
				mapLegend[Map.TileToLookup(104, 0)] = "Grandfather Clock";
				mapLegend[Map.TileToLookup(105, 0)] = "Statue";
				mapLegend[Map.TileToLookup(105, 2)] = "Vase";
				mapLegend[Map.TileToLookup(106, 0)] = "Sawmill";
				mapLegend[Map.TileToLookup(107, 0)] = "Cobalt";
				mapLegend[Map.TileToLookup(108, 0)] = "Mythril";
				mapLegend[Map.TileToLookup(111, 0)] = "Adamantite";
				mapLegend[Map.TileToLookup(114, 0)] = "Tinkerer's Workshop";
				mapLegend[Map.TileToLookup(125, 0)] = "Crystal Ball";
				mapLegend[Map.TileToLookup(128, 0)] = "Mannequin";
				mapLegend[Map.TileToLookup(129, 0)] = "Crystal Shard";
				mapLegend[Map.TileToLookup(132, 0)] = "Lever";
				mapLegend[Map.TileToLookup(133, 0)] = "Adamantite Forge";
				mapLegend[Map.TileToLookup(133, 1)] = "Titanium Forge";
				mapLegend[Map.TileToLookup(134, 0)] = "Mythril Anvil";
				mapLegend[Map.TileToLookup(134, 1)] = "Orichalcum Anvil";
				mapLegend[Map.TileToLookup(136, 0)] = "Switch";
				mapLegend[Map.TileToLookup(137, 0)] = "Trap";
				mapLegend[Map.TileToLookup(138, 0)] = "Boulder";
				mapLegend[Map.TileToLookup(139, 0)] = "Music Box";
				mapLegend[Map.TileToLookup(142, 0)] = "Inlet Pump";
				mapLegend[Map.TileToLookup(143, 0)] = "Outlet Pump";
				mapLegend[Map.TileToLookup(144, 0)] = "Timer";
				mapLegend[Map.TileToLookup(149, 0)] = "Christmas Light";
				mapLegend[Map.TileToLookup(166, 0)] = "Tin";
				mapLegend[Map.TileToLookup(167, 0)] = "Lead";
				mapLegend[Map.TileToLookup(168, 0)] = "Tungsten";
				mapLegend[Map.TileToLookup(169, 0)] = "Platinum";
				mapLegend[Map.TileToLookup(170, 0)] = "Pine Tree";
				mapLegend[Map.TileToLookup(171, 0)] = "Christmas Tree";
				mapLegend[Map.TileToLookup(173, 0)] = "Candelabra";
				mapLegend[Map.TileToLookup(174, 0)] = "Platinum Candle";
				mapLegend[Map.TileToLookup(178, 0)] = Main.itemName[181];
				mapLegend[Map.TileToLookup(178, 1)] = Main.itemName[180];
				mapLegend[Map.TileToLookup(178, 2)] = Main.itemName[177];
				mapLegend[Map.TileToLookup(178, 3)] = Main.itemName[179];
				mapLegend[Map.TileToLookup(178, 4)] = Main.itemName[178];
				mapLegend[Map.TileToLookup(178, 5)] = Main.itemName[182];
				mapLegend[Map.TileToLookup(178, 6)] = Main.itemName[999];
				mapLegend[Map.TileToLookup(191, 0)] = "Living Wood";
				mapLegend[Map.TileToLookup(204, 0)] = "Crimtane";
				mapLegend[Map.TileToLookup(207, 0)] = "Water Fountain";
				mapLegend[Map.TileToLookup(209, 0)] = "Cannon";
				mapLegend[Map.TileToLookup(211, 0)] = "Chlorophyte";
				mapLegend[Map.TileToLookup(212, 0)] = "Turret";
				mapLegend[Map.TileToLookup(213, 0)] = "Rope";
				mapLegend[Map.TileToLookup(214, 0)] = "Chain";
				mapLegend[Map.TileToLookup(215, 0)] = "Campfire";
				mapLegend[Map.TileToLookup(216, 0)] = "Rocket";
				mapLegend[Map.TileToLookup(217, 0)] = "Blend-O-Matic";
				mapLegend[Map.TileToLookup(218, 0)] = "Meat Grinder";
				mapLegend[Map.TileToLookup(219, 0)] = "Silt Extractinator";
				mapLegend[Map.TileToLookup(220, 0)] = "Solidifier";
				mapLegend[Map.TileToLookup(221, 0)] = "Palladium";
				mapLegend[Map.TileToLookup(222, 0)] = "Orichalcum";
				mapLegend[Map.TileToLookup(223, 0)] = "Titanium";
				mapLegend[Map.TileToLookup(227, 0)] = Main.itemName[1107];
				mapLegend[Map.TileToLookup(227, 1)] = Main.itemName[1108];
				mapLegend[Map.TileToLookup(227, 2)] = Main.itemName[1109];
				mapLegend[Map.TileToLookup(227, 3)] = Main.itemName[1110];
				mapLegend[Map.TileToLookup(227, 4)] = Main.itemName[1111];
				mapLegend[Map.TileToLookup(227, 5)] = Main.itemName[1112];
				mapLegend[Map.TileToLookup(227, 6)] = Main.itemName[1113];
				mapLegend[Map.TileToLookup(227, 7)] = Main.itemName[1114];
				mapLegend[Map.TileToLookup(228, 0)] = "Dye Vat";
				mapLegend[Map.TileToLookup(231, 0)] = "Larva";
				mapLegend[Map.TileToLookup(232, 0)] = "Wooden Spike";
				mapLegend[Map.TileToLookup(235, 0)] = "Teleporter";
				mapLegend[Map.TileToLookup(236, 0)] = "Life Fruit";
				mapLegend[Map.TileToLookup(237, 0)] = "Lihzahrd Altar";
				mapLegend[Map.TileToLookup(238, 0)] = "Plantera's Bulb";
				mapLegend[Map.TileToLookup(239, 0)] = "Metal Bar";
				mapLegend[Map.TileToLookup(240, 0)] = "Trophy";
				mapLegend[Map.TileToLookup(240, 2)] = Main.npcName[21];
				mapLegend[Map.TileToLookup(240, 3)] = "Item Rack";
				mapLegend[Map.TileToLookup(240, 4)] = Main.itemName[2442];
				mapLegend[Map.TileToLookup(241, 0)] = Main.itemName[1417];
				mapLegend[Map.TileToLookup(242, 0)] = "Painting";
				mapLegend[Map.TileToLookup(242, 1)] = "Animal Skin";
				mapLegend[Map.TileToLookup(243, 0)] = "Imbuing Station";
				mapLegend[Map.TileToLookup(244, 0)] = "Bubble Machine";
				mapLegend[Map.TileToLookup(245, 0)] = "Picture";
				mapLegend[Map.TileToLookup(246, 0)] = "Picture";
				mapLegend[Map.TileToLookup(247, 0)] = "Autohammer";
				mapLegend[Map.TileToLookup(254, 0)] = "Pumpkin";
				mapLegend[Map.TileToLookup(269, 0)] = "Womannequin";
				mapLegend[Map.TileToLookup(270, 0)] = "Firefly in a Bottle";
				mapLegend[Map.TileToLookup(271, 0)] = "Lightning Bug in a Bottle";
				mapLegend[Map.TileToLookup(275, 0)] = "Bunny Cage";
				mapLegend[Map.TileToLookup(276, 0)] = "Squirrel Cage";
				mapLegend[Map.TileToLookup(277, 0)] = "Mallard Duck Cage";
				mapLegend[Map.TileToLookup(278, 0)] = "Duck Cage";
				mapLegend[Map.TileToLookup(279, 0)] = "Bird Cage";
				mapLegend[Map.TileToLookup(280, 0)] = "Blue Jay Cage";
				mapLegend[Map.TileToLookup(281, 0)] = "Cardinal Cage";
				mapLegend[Map.TileToLookup(282, 0)] = "Fish Bowl";
				mapLegend[Map.TileToLookup(283, 0)] = "Heavy Work Bench";
				mapLegend[Map.TileToLookup(285, 0)] = "Snail Cage";
				mapLegend[Map.TileToLookup(286, 0)] = "Glowing Snail Cage";
				mapLegend[Map.TileToLookup(287, 0)] = "Ammo Box";
				mapLegend[Map.TileToLookup(288, 0)] = "Monarch Butterfly Jar";
				mapLegend[Map.TileToLookup(289, 0)] = "Purple Emperor Butterfly Jar";
				mapLegend[Map.TileToLookup(290, 0)] = "Red Admiral Butterfly Jar";
				mapLegend[Map.TileToLookup(291, 0)] = "Ulysses Butterfly Jar";
				mapLegend[Map.TileToLookup(292, 0)] = "Sulphur Butterfly Jar";
				mapLegend[Map.TileToLookup(293, 0)] = "Tree Nymph Butterfly Jar";
				mapLegend[Map.TileToLookup(294, 0)] = "Zebra Swallowtail Butterfly Jar";
				mapLegend[Map.TileToLookup(295, 0)] = "Julia Butterfly Jar";
				mapLegend[Map.TileToLookup(296, 0)] = "Scorpion Cage";
				mapLegend[Map.TileToLookup(297, 0)] = "Black Scorpion Cage";
				mapLegend[Map.TileToLookup(298, 0)] = "Frog Cage";
				mapLegend[Map.TileToLookup(299, 0)] = "Mouse Cage";
				mapLegend[Map.TileToLookup(300, 0)] = "Bone Welder";
				mapLegend[Map.TileToLookup(301, 0)] = "Flesh Cloning Vat";
				mapLegend[Map.TileToLookup(302, 0)] = "Glass Kiln";
				mapLegend[Map.TileToLookup(303, 0)] = "Lihzahrd Furnace";
				mapLegend[Map.TileToLookup(304, 0)] = "Living Loom";
				mapLegend[Map.TileToLookup(305, 0)] = "Sky Mill";
				mapLegend[Map.TileToLookup(306, 0)] = "Ice Machine";
				mapLegend[Map.TileToLookup(307, 0)] = "Steampunk Boiler";
				mapLegend[Map.TileToLookup(308, 0)] = "Honey Dispenser";
				mapLegend[Map.TileToLookup(309, 0)] = "Penguin Cage";
				mapLegend[Map.TileToLookup(310, 0)] = "Worm Cage";
				mapLegend[Map.TileToLookup(316, 0)] = "Blue Jellyfish Bowl";
				mapLegend[Map.TileToLookup(317, 0)] = "Green Jellyfish Bowl";
				mapLegend[Map.TileToLookup(318, 0)] = "Pink Jellyfish Bowl";
				mapLegend[Map.TileToLookup(319, 0)] = "Ship in a Bottle";
				mapLegend[Map.TileToLookup(320, 0)] = "Seaweed Planter";
				mapLegend[Map.TileToLookup(323, 0)] = "Palm Tree";
				mapLegend[Map.TileToLookup(314, 0)] = "Minecart Track";
				for (int i = 0; i < mapLegend.Length; i++)
				{
					if (mapLegend[i] == null)
					{
						mapLegend[i] = string.Empty;
					}
				}
				chestType[0] = "Chest";
				chestType[1] = "Gold Chest";
				chestType[2] = "Locked Gold Chest";
				chestType[3] = "Shadow Chest";
				chestType[4] = "Locked Shadow Chest";
				chestType[5] = "Barrel";
				chestType[6] = "Trash Can";
				chestType[7] = "Ebonwood Chest";
				chestType[8] = "Rich Mahogany Chest";
				chestType[9] = "Pearlwood Chest";
				chestType[10] = "Ivy Chest";
				chestType[11] = "Ice Chest";
				chestType[12] = "Living Wood Chest";
				chestType[13] = "Skyware Chest";
				chestType[14] = "Shadewood Chest";
				chestType[15] = "Web Covered Chest";
				chestType[16] = "Lihzahrd Chest";
				chestType[17] = "Water Chest";
				chestType[18] = "Jungle Chest";
				chestType[19] = "Corruption Chest";
				chestType[20] = "Crimson Chest";
				chestType[21] = "Hallowed Chest";
				chestType[22] = "Frozen Chest";
				chestType[23] = "Locked Jungle Chest";
				chestType[24] = "Locked Corruption Chest";
				chestType[25] = "Locked Crimson Chest";
				chestType[26] = "Locked Hallowed Chest";
				chestType[27] = "Locked Frozen Chest";
				chestType[28] = "Dynasty Chest";
				chestType[29] = "Honey Chest";
				chestType[30] = "Steampunk Chest";
				chestType[31] = "Palm Wood Chest";
				chestType[32] = "Mushroom Chest";
				chestType[33] = "Boreal Wood Chest";
				chestType[34] = "Slime Chest";
				chestType[35] = "Green Dungeon Chest";
				chestType[36] = "Locked Green Dungeon Chest";
				chestType[37] = "Pink Dungeon Chest";
				chestType[38] = "Locked Pink Dungeon Chest";
				chestType[39] = "Blue Dungeon Chest";
				chestType[40] = "Locked Blue Dungeon Chest";
				chestType[41] = "Bone Chest";
				chestType[42] = "Cactus Chest";
				chestType[43] = "Flesh Chest";
				chestType[44] = "Obsidian Chest";
				chestType[45] = "Pumpkin Chest";
				chestType[46] = "Spooky Chest";
				chestType[47] = "Glass Chest";
				prefix[1] = "Large";
				prefix[2] = "Massive";
				prefix[3] = "Dangerous";
				prefix[4] = "Savage";
			...
			else if (lang == 2)
			{
				...
				misc[5] = "Der Frost ist Legion aus dem Westen näher!";
				misc[6] = "Der Frost ist Legion aus dem Osten näher!";
				...
				misc[19] = " wurde durch...";
				misc[20] = "Eine Sonnenfinsternis ist passiert!";
				misc[21] = "Ihre Welt ist mit Palladium gesegnet worden!";
				misc[22] = "Ihre Welt hat mit Orichalcum gesegnet worden!";
				misc[23] = "Ihre Welt hat sich mit Titanium gesegnet worden!";
				misc[24] = "Die Piraten wurden besiegt!";
				misc[25] = "Piraten sind aus dem Westen näher!";
				misc[26] = "Piraten sind aus dem Osten näher!";
				misc[27] = "Die Piraten sind angekommen!";
				misc[28] = "Sie fühlen sich Schwingungen von tief unter ...";
				misc[29] = "Das wird eine schreckliche Nacht sein ...";
				misc[30] = "Die Luft wird kälter um dich herum ...";
				...
				menu[102] = "Wählen Sie die Sprache";
				menu[103] = "Sprache";
				menu[104] = "Ja";
				menu[105] = "Nicht";
				menu[106] = "Toggle Map-Stil";
				menu[107] = "umschalten Vollbild";
				menu[108] = "vergrößern";
				menu[109] = "Verkleinern";
				menu[110] = "Verringern Transparenz";
				menu[111] = "Erhöhung der Transparenz";
				menu[112] = "Karte Aktiviert";
				menu[113] = "Karte für Behinderte";
				...
				gen[56] = "Hinzufügen Schnee ...";
				gen[57] = "Welt";
				gen[58] = "Erstellen Verlies:";
				gen[59] = "Ein Meteorit ist gelandet!";
				gen[60] = "Glättung der Welt:";
				gen[61] = "Mossification:";
				gen[62] = "Gemification:";
				gen[63] = "Machen Höhlewänden:";
				gen[64] = "Wachsende Spinne Höhlen:";
				gen[65] = "Clearing Kartendaten:";
				gen[66] = "Speichern von Kartendaten:";
				gen[67] = "Die Karte wird geladen Daten:";
				gen[68] = "Zeichnen Karte:";
				gen[69] = "Erstellen Wasserfälle:";
				gen[70] = "Erstellen Dschungelruinen...";
				gen[71] = "Erstellen Hornisse Nester...";
				gen[72] = "Machen Sie die Welt blutige:";
				inter[0] = "Leben:";
				inter[1] = "Atem";
				inter[2] = "Mana";
				inter[3] = "Muelleimer";
				...
				inter[53] = "Wasser";
				inter[54] = "Heilen";
				inter[55] = "Dieses Gehäuse erfüllt nicht die Anforderungen für eine";
				inter[56] = "Lava";
				inter[57] = "Färben";
				inter[58] = "Liebling";
				inter[61] = "Umbenennen";
				inter[62] = "Einstellungen";
				inter[63] = "Abbrechen";
				tip[0] = "Ausgestattet in sozialen Schlitz";
				...
				mapLegend[Map.TileToLookup(13, 0)] = "Flasche";
				mapLegend[Map.TileToLookup(14, 0)] = "Tabelle";
				mapLegend[Map.TileToLookup(15, 0)] = "Stuhl";
				mapLegend[Map.TileToLookup(16, 0)] = "Amboss";
				mapLegend[Map.TileToLookup(17, 0)] = "Ofen";
				mapLegend[Map.TileToLookup(18, 0)] = "Werkbank";
				mapLegend[Map.TileToLookup(26, 0)] = "Dämon Altar";
				mapLegend[Map.TileToLookup(77, 0)] = "Hoellenschmiede";
				mapLegend[Map.TileToLookup(86, 0)] = "Webstuhl";
				mapLegend[Map.TileToLookup(94, 0)] = "Gaerbottich";
				mapLegend[Map.TileToLookup(96, 0)] = "Kochtopf";
				mapLegend[Map.TileToLookup(101, 0)] = "Buecherregal";
				mapLegend[Map.TileToLookup(106, 0)] = "Saegewerk";
				mapLegend[Map.TileToLookup(114, 0)] = "Tueftler-Werkstatt";
				mapLegend[Map.TileToLookup(133, 0)] = "Adamantitschmiede";
				mapLegend[Map.TileToLookup(134, 0)] = "Mithrilamboss";
				prefix[1] = "Gross";
				prefix[2] = "Massiv";
				prefix[3] = "Gefährlich";
				prefix[4] = "Barbarisch";
				...
				prefix[6] = "Spitze";
				prefix[7] = "Winzig";
				prefix[8] = "Schrecklicher";
				prefix[9] = "Klein";
				prefix[10] = "Stumpf";
				prefix[11] = "Unglücklich";
				prefix[12] = "Sperrig";
				prefix[13] = "Beschämend";
				prefix[14] = "Schwer";
				prefix[15] = "Locker";
				prefix[16] = "Gesichtet";
				prefix[17] = "Schnell";
				prefix[18] = "Hastig";
				prefix[19] = "Einschüchternd";
				prefix[20] = "Tödlich";
				prefix[21] = "Stillen";
				prefix[22] = "Schrecklich";
				prefix[23] = "Lethargisch";
				prefix[24] = "Unbeholfen";
				prefix[25] = "Mächtig";
				prefix[26] = "Mystisch";
				prefix[27] = "Geschickt";
				prefix[28] = "Meisterhaft";
				prefix[29] = "Ungeschickt";
				prefix[30] = "Unwissend";
				prefix[31] = "Gestört";
				prefix[32] = "Intensiv";
				prefix[33] = "Tabu";
				...
				prefix[38] = "Kraftvoll";
				prefix[39] = "Gebrochen";
				prefix[40] = "Beschädigt";
				prefix[41] = "Schäbig";
				prefix[42] = "Rasch";
				prefix[43] = "Tödlich";
				prefix[44] = "Agil";
				prefix[45] = "Wendig";
				prefix[46] = "Mörderisch";
				prefix[47] = "Langsam";
				prefix[48] = "Träge";
				prefix[49] = "Faul";
				prefix[50] = "Lästig";
				prefix[51] = "Böse";
				prefix[52] = "Manisch";
				prefix[53] = "Verletzend";
				prefix[54] = "Stark";
				prefix[55] = "Unangenehm";
				prefix[56] = "Schwach";
				prefix[57] = "Rücksichtslos";
				prefix[58] = "Rasend";
				prefix[59] = "Fromm";
				prefix[60] = "Dämonisch";
				prefix[61] = "Eifrig";
				...
				prefix[64] = "Gepanzert";
				prefix[65] = "Defensiv";
				prefix[66] = "Geheimnisvoll";
				prefix[67] = "Präzise";
				prefix[68] = "Glücklich";
				prefix[69] = "Gezackt";
				prefix[70] = "Spike";
				prefix[71] = "Wütend";
				prefix[72] = "Bedrohlich";
				prefix[73] = "Rege";
				prefix[74] = "Flüchtig";
				prefix[75] = "Hastig";
				prefix[76] = "Rasch";
				prefix[77] = "Wild";
				prefix[78] = "Voreilig";
				prefix[79] = "Unerschrocken";
				prefix[80] = "Gewalttätig";
				prefix[81] = "Legendär";
				prefix[82] = "Unwirklich";
				prefix[83] = "Mythisch";
			}
			else if (lang == 3)
			{
				misc[0] = "L'esercito di goblin è stato sconfitto! ";
				misc[1] = "Un esercito di goblin si sta avvicinando da ovest!";
				misc[2] = "Un esercito di goblin si sta avvicinando da est!";
				misc[3] = "Un esercito di goblin è arrivato!";
				misc[4] = "La Legione di Frost è stato sconfitto!";
				misc[5] = "La Legione gelo si sta avvicinando da ovest!";
				misc[6] = "La Legione gelo si sta avvicinando da est!";
				misc[7] = "La Legione gelo è arrivato!";
				...
				misc[20] = "Un eclissi solare sta accadendo!";
				misc[21] = "Il vostro mondo è stato benedetto con Palladium!";
				misc[22] = "Il vostro mondo è stato benedetto con oricalco!";
				misc[23] = "Your world has been blessed with titanium!";
				misc[24] = "I pirati sono stati sconfitti!";
				misc[25] = "I pirati si stanno avvicinando da ovest!";
				misc[26] = "I pirati si stanno avvicinando da est!";
				misc[27] = "I pirati sono arrivati!";
				misc[28] = "Ti senti vibrazioni profondità sotto ...";
				misc[29] = "Questa sarà una notte terribile ...";
				misc[30] = "L'aria è sempre più fredda intorno a te ...";
				...
				menu[59] = "Qualità: automatica";
				menu[60] = "Qualità: alta";
				menu[61] = "Qualità: media";
				menu[62] = "Qualità: bassa";
				menu[63] = "Video";
				...
				menu[104] = "Sì";
				menu[105] = "No";
				menu[106] = "mappa levetta stile";
				menu[107] = "Alterna a tutto schermo";
				menu[108] = "zoom in";
				menu[109] = "rimpicciolire";
				menu[110] = "diminuire Trasparenza";
				menu[111] = "aumentare la trasparenza";
				menu[112] = "mappa attivato";
				menu[113] = "mappa Disabilitato";
				...
				gen[59] = "Un meteorite è atterrato!";
				gen[60] = "Smoothing il mondo:";
				gen[61] = "Mossification:";
				gen[62] = "Gemification:";
				gen[63] = "Fare pareti delle caverne:";
				gen[64] = "Crescere grotte ragno:";
				gen[65] = "Clearing mappa dati:";
				gen[66] = "Salvataggio dei dati della mappa:";
				gen[67] = "Caricamento dati della mappa:";
				gen[68] = "disegnare la mappa:";
				gen[69] = "creazione di cascate:";
				gen[70] = "Creazione di rovine della giungla...";
				gen[71] = "Creazione di nidi di calabrone...";
				gen[72] = "Rendere il mondo insanguinato:";
				inter[0] = "Vita:";
				inter[1] = "Respiro";
				inter[2] = "Mana ";
				inter[3] = "Bidone";
				...
				inter[42] = "Questo alloggio è distrutto.";
				...
				inter[53] = "Acqua";
				inter[54] = "Guarire";
				inter[55] = "Questa custodia non soddisfa i requisiti per un";
				inter[56] = "lavica";
				inter[57] = "tingere";
				inter[58] = "dolcezza";
				inter[61] = "Rinominare";
				inter[62] = "Impostazioni";
				inter[63] = "Annulla";
				...
				mp[13] = "non è più in un gruppo.";
				mp[14] = "si è unito al gruppo rosso.";
				mp[15] = "si è unito al gruppo verde.";
				mp[16] = "si è unito al gruppo blu.";
				mp[17] = "si è unito al gruppo giallo.";
				mp[18] = "Benevenuto a";
				mp[19] = "ha aderito.";
				mp[20] = "ha smesso di.";
				the = "la ";
				...
				mapLegend[Map.TileToLookup(13, 0)] = "Bottiglia";
				mapLegend[Map.TileToLookup(14, 0)] = "Tavolo";
				mapLegend[Map.TileToLookup(15, 0)] = "Sedia";
				mapLegend[Map.TileToLookup(16, 0)] = "Incudine";
				mapLegend[Map.TileToLookup(17, 0)] = "Forno";
				mapLegend[Map.TileToLookup(18, 0)] = "Banco di lavoro";
				mapLegend[Map.TileToLookup(26, 0)] = "Demone altare";
				mapLegend[Map.TileToLookup(77, 0)] = "Creazione degli inferi";
				mapLegend[Map.TileToLookup(86, 0)] = "Telaio";
				mapLegend[Map.TileToLookup(94, 0)] = "Barilotto";
				mapLegend[Map.TileToLookup(96, 0)] = "Pentola";
				mapLegend[Map.TileToLookup(101, 0)] = "Scaffale";
				mapLegend[Map.TileToLookup(106, 0)] = "Segheria";
				mapLegend[Map.TileToLookup(114, 0)] = "Laboratorio dell'inventore";
				mapLegend[Map.TileToLookup(133, 0)] = "Fornace di adamantio";
				mapLegend[Map.TileToLookup(134, 0)] = "Incudine di mitrilio";
				prefix[1] = "Grande";
				prefix[2] = "Massiccio";
				prefix[3] = "Pericoloso";
				prefix[4] = "Selvaggio";
				...
				prefix[10] = "Opaco";
				prefix[11] = "Infelice";
				prefix[12] = "Ingombrante";
				prefix[13] = "Vergognoso";
				prefix[14] = "Pesante";
				prefix[15] = "Luce";
				prefix[16] = "Avvistato";
				prefix[17] = "Rapido";
				prefix[18] = "Frettoloso";
				prefix[19] = "Intimidatorio";
				prefix[20] = "Mortale";
				prefix[21] = "Convinto";
				prefix[22] = "Orribile";
				prefix[23] = "Letargico";
				...
				prefix[26] = "Mistico";
				prefix[27] = "Esperto";
				prefix[28] = "Magistrale";
				prefix[29] = "Inetto";
				prefix[30] = "Ignorante";
				prefix[31] = "Squilibrato";
				prefix[32] = "Intenso";
				prefix[33] = "Tabù";
				prefix[34] = "Celeste";
				prefix[35] = "Furioso";
				prefix[36] = "Appassionato";
				prefix[37] = "Superiore";
				prefix[38] = "Forte";
				prefix[39] = "Rotto";
				prefix[40] = "Danneggiato";
				prefix[41] = "Scadente";
				prefix[42] = "Veloce";
				prefix[43] = "Mortale";
				prefix[44] = "Agile";
				...
				prefix[48] = "Pigro";
				prefix[49] = "Indolente";
				prefix[50] = "Fastidioso";
				prefix[51] = "Brutto";
				prefix[52] = "Maniaco";
				prefix[53] = "Offensivo";
				prefix[54] = "Robusto";
				prefix[55] = "Sgradevole";
				prefix[56] = "Debole";
				prefix[57] = "Spietato";
				prefix[58] = "Frenetico";
				prefix[59] = "Devoto";
				...
				prefix[61] = "Zelante";
				prefix[62] = "Duro";
				prefix[63] = "Protettivo";
				prefix[64] = "Corazzato";
				prefix[65] = "Difensivo";
				prefix[66] = "Arcano";
				prefix[67] = "Preciso";
				prefix[68] = "Fortunato";
				prefix[69] = "Frastagliato";
				prefix[70] = "Spillo";
				prefix[71] = "Arrabbiato";
				prefix[72] = "Minaccioso";
				prefix[73] = "Vivace";
				prefix[74] = "Fugace";
				prefix[75] = "Frettoloso";
				prefix[76] = "Veloce";
				prefix[77] = "Selvaggio";
				prefix[78] = "Temerario";
				prefix[79] = "Intrepido";
				prefix[80] = "Violento";
				prefix[81] = "Leggendario";
				prefix[82] = "Irreale";
				prefix[83] = "Mitico";
			}
			else if (lang == 4)
			{
				...
				misc[3] = "Une armée gobelin est arrivé!";
				misc[4] = "La Légion Frost a été vaincu!";
				misc[5] = "La Légion Frost est venant de l'ouest!";
				misc[6] = "La Légion Frost est l'approche de l'Est!";
				misc[7] = "La Légion gel est arrivé!";
				misc[8] = "La lune de sang se lève...";
				...
				misc[18] = "est arrivée.";
				misc[19] = " s'est fait éviscérer...";
				misc[20] = "Une éclipse solaire se produit!";
				misc[21] = "Votre monde a été béni avec Palladium!";
				misc[22] = "Votre monde a été béni avec orichalque!";
				misc[23] = "Votre monde a été béni avec Titanium!";
				misc[24] = "Les pirates ont été vaincus!";
				misc[25] = "Les pirates venant de l'ouest!";
				misc[26] = "Pirates se rapprochent de l'Est!";
				misc[27] = "Les pirates sont arrivés!";
				misc[28] = "Vous vous sentez des vibrations du plus profond ci-dessous ...";
				misc[29] = "Cela va être une nuit terrible ...";
				misc[30] = "L'air se refroidit autour de vous ...";
				menu[0] = "Démarrez une nouvelle instance de Terraria pour rejoindre une partie.";
				...
				menu[11] = "Aucune sauvegarde trouvée";
				menu[12] = "Un joueur";
				menu[13] = "Multijoueur";
				menu[14] = "Réglages";
				menu[15] = "Quitter";
				...
				menu[27] = "Aléatoire";
				menu[28] = "Créer";
				menu[29] = "En cas de mort dans le mode Difficile, le personnage est tout simplement supprimé";
				menu[30] = "En cas de mort dans le mode Normal, les personnages laissent échapper des objets en mourant";
				menu[31] = "Les personnages en mode facile laissent échapper de l'argent en mourant.";
				...
				menu[46] = "Supprimer";
				menu[47] = "Créer un monde";
				menu[48] = "Saisir un nom de monde :";
				menu[49] = "Mode fenêtré";
				menu[50] = "Mode Plein écran";
				menu[51] = "Résolution";
				menu[52] = "Parallax";
				menu[53] = "Frame Skip activé (non recommandé)";
				menu[54] = "Frame Skip désactivé (recommandé)";
				menu[55] = "Lumière : couleur";
				menu[56] = "Lumière : blanche";
				menu[57] = "Lumière : rétro";
				menu[58] = "Lumière : psyché";
				menu[59] = "Qualité : auto";
				menu[60] = "Qualité : haute";
				menu[61] = "Qualité : moyenne";
				menu[62] = "Qualité : basse";
				menu[63] = "Vidéo";
				...
				menu[69] = "Pause auto activée";
				menu[70] = "Pause auto désactivée";
				menu[71] = "Affichage du texte activé";
				menu[72] = "Affichage du texte désactivé";
				menu[73] = "Résolution Plein écran";
				menu[74] = "Haut              ";
				menu[75] = "Bas               ";
				menu[76] = "Gauche           ";
				menu[77] = "Droite             ";
				...
				menu[83] = "Buff rapide      ";
				menu[84] = "Agripper          ";
				menu[85] = "Sélection auto    ";
				menu[86] = "Réglages par défaut";
				menu[87] = "Rejoindre";
				menu[88] = "Héberger et jouer";
				...
				menu[102] = "Sélectionnez la langue";
				menu[103] = "Langue";
				menu[104] = "Oui";
				menu[105] = "Pas";
				menu[106] = "Basculer Carte de style";
				menu[107] = "basculer Plein écran";
				menu[108] = "Zoom";
				menu[109] = "Zoom arrière";
				menu[110] = "Diminution de la transparence";
				menu[111] = "augmenter la transparence";
				menu[112] = "carte Activé";
				menu[113] = "carte handicapés";
				...
				gen[30] = "Dissimulation de trésor :";
				gen[31] = "Dissimulation de trésor supplémentaire :";
				gen[32] = "Dissimulation de trésor de jungle :";
				gen[33] = "Dissimulation de trésor dans l'eau :";
				...
				gen[46] = "Libération des ressources inutilisées :";
				gen[47] = "Réinitialisation des objets du jeu :";
				gen[48] = "Réglage du mode difficile...";
				gen[49] = "Sauvegarde des données du monde :";
				gen[50] = "Sauvegarde du fichier du monde...";
				gen[51] = "Chargement des données du monde :";
				gen[52] = "Vérification de l'alignement de blocs :";
				gen[53] = "Le chargement a échoué.";
				gen[54] = "Aucune sauvegarde trouvée.";
				gen[55] = "Trouver les images de blocs :";
				gen[56] = "Ajout de la neige ...";
				gen[57] = "Mondiale";
				gen[58] = "Créer donjon:";
				gen[59] = "Une météorite a atterri!";
				gen[60] = "Lissage du monde:";
				gen[61] = "Mossification:";
				gen[62] = "Gemification:";
				gen[63] = "Faire parois de la grotte:";
				gen[64] = "Growing grottes d'araignée:";
				gen[65] = "Clearing données cartographiques:";
				gen[66] = "Sauvegarde des données de la carte:";
				gen[67] = "Chargement des données cartographiques:";
				gen[68] = "dessin carte:";
				gen[69] = "créer des cascades:";
				gen[70] = "Création ruines dans la jungle...";
				gen[71] = "Création de nids de frelons...";
				gen[72] = "Faire la sanglante monde:";
				inter[0] = "Vie :";
				inter[1] = "Souffle ";
				inter[2] = "Mana :";
				inter[3] = "Poubelle";
				inter[4] = "Inventaire";
				inter[5] = "Barre d'inventaire déverrouillée";
				inter[6] = "Barre d'inventaire verrouillée";
				inter[7] = "Logement";
				...
				inter[23] = "Aucun";
				inter[24] = "Placer un matériau ici pour afficher les techniques";
				inter[25] = "Artisanat";
				inter[26] = "Pièces";
				inter[27] = "Munitions";
				inter[28] = "Magasin";
				...
				inter[43] = "La connexion a été interrompue";
				...
				inter[53] = "De l'eau";
				inter[54] = "Guérir";
				inter[55] = "Ce logement ne répond pas aux exigences d'un";
				inter[56] = "Lave";
				inter[57] = "teindre";
				inter[58] = "chérie";
				inter[61] = "Rebaptiser";
				...
				tip[52] = "consomme ";
				tip[53] = " convoquer des dommages";
				tip[54] = " gamme";
				tip[55] = " dommage";
				mp[0] = "Recevoir :";
				mp[1] = "Mot de passe incorrect.";
				mp[2] = "Opération non valable en l'état.";
				mp[3] = "Vous vous êtes fait bannir de ce serveur.";
				mp[4] = "Vous n'utilisez pas la même version que ce serveur.";
				mp[5] = "est déjà sur ce serveur.";
				mp[6] = "/en train de jouer";
				mp[7] = "Joueurs actuels :";
				mp[8] = "/jet";
				mp[9] = "lance un";
				mp[10] = "Vous n'êtes pas dans une équipe.";
				mp[11] = "a activé le PvP.";
				mp[12] = "a désactivé le PvP.";
				mp[13] = "n'est plus dans une équipe.";
				mp[14] = "a rejoint l'équipe rouge.";
				mp[15] = "a rejoint l'équipe verte.";
				mp[16] = "a rejoint l'équipe bleue.";
				mp[17] = "a rejoint l'équipe jaune.";
				...
				mapLegend[Map.TileToLookup(13, 0)] = "Bouteille";
				mapLegend[Map.TileToLookup(14, 0)] = "Table";
				mapLegend[Map.TileToLookup(15, 0)] = "Président";
				mapLegend[Map.TileToLookup(16, 0)] = "Enclume";
				mapLegend[Map.TileToLookup(17, 0)] = "Four";
				mapLegend[Map.TileToLookup(18, 0)] = "Établi";
				mapLegend[Map.TileToLookup(26, 0)] = "Autel démon";
				mapLegend[Map.TileToLookup(77, 0)] = "Forge infernale";
				mapLegend[Map.TileToLookup(86, 0)] = "Métier à tisser";
				mapLegend[Map.TileToLookup(94, 0)] = "Tonnelet";
				mapLegend[Map.TileToLookup(96, 0)] = "Marmite";
				mapLegend[Map.TileToLookup(101, 0)] = "Bibliothèque";
				mapLegend[Map.TileToLookup(106, 0)] = "Scierie";
				mapLegend[Map.TileToLookup(114, 0)] = "Atelier du bricoleur";
				mapLegend[Map.TileToLookup(133, 0)] = "Forge en adamantine";
				mapLegend[Map.TileToLookup(134, 0)] = "Enclume en mythril";
				prefix[1] = "Grand";
				prefix[2] = "Massif";
				prefix[3] = "Dangereuses";
				prefix[4] = "Sauvages";
				prefix[5] = "Coupante";
				prefix[6] = "Pointues";
				prefix[7] = "Minuscules";
				...
				prefix[9] = "Petit";
				prefix[10] = "Terne";
				prefix[11] = "Malheureux";
				prefix[12] = "Volumineux";
				prefix[13] = "Honteux";
				prefix[14] = "Lourds";
				prefix[15] = "Léger";
				prefix[16] = "Voyants";
				prefix[17] = "Rapide";
				prefix[18] = "Hâtif";
				prefix[19] = "Intimidant";
				prefix[20] = "Mortelle";
				prefix[21] = "Dévoué";
				prefix[22] = "Affreux";
				prefix[23] = "Léthargique";
				prefix[24] = "Scomodo";
				prefix[25] = "Puissante";
				prefix[26] = "Mystique";
				prefix[27] = "Expert";
				...
				prefix[35] = "Furieux";
				prefix[36] = "Vif";
				prefix[37] = "Supérieure";
				prefix[38] = "Énergique";
				prefix[39] = "Rompu";
				prefix[40] = "Endommagés";
				prefix[41] = "Mesquin";
				prefix[42] = "Prompt";
				prefix[43] = "Mortelle";
				prefix[44] = "Agile";
				...
				prefix[53] = "Blessant";
				prefix[54] = "Robuste";
				prefix[55] = "Désagréables";
				prefix[56] = "Faibles";
				prefix[57] = "Impitoyable";
				prefix[58] = "Frénétique";
				prefix[59] = "Pieux";
				prefix[60] = "Démoniaque";
				prefix[61] = "Zélé";
				prefix[62] = "Durs";
				prefix[63] = "Protecteur";
				prefix[64] = "Blindés";
				prefix[65] = "Défensif";
				prefix[66] = "Ésotérique";
				prefix[67] = "Précise";
				prefix[68] = "Chanceux";
				prefix[69] = "Déchiqueté";
				prefix[70] = "Pointes";
				prefix[71] = "Fâché";
				prefix[72] = "Menaçant";
				prefix[73] = "Brusque";
			...
			else if (lang == 5)
			{
				...
				misc[3] = "Un ejército goblin ha llegado!";
				misc[4] = "La Legión Frost ha sido derrotado!";
				misc[5] = "La Legión de Frost se aproxima desde el oeste!";
				misc[6] = "La Legión de Frost se acercaba desde el este!";
				misc[7] = "La Legión Frost ha llegado!";
				misc[8] = "La luna sangrienta está saliendo...";
				...
				misc[20] = "Un eclipse solar ocurre!";
				misc[21] = "Su mundo ha sido bendecido con el Palladium!";
				misc[22] = "Su mundo ha sido bendecido con Orichalcum!";
				misc[23] = "Su mundo ha sido bendecido con Titanium!";
				misc[24] = "Los piratas han sido derrotados!";
				misc[25] = "Piratas se están acercando desde el oeste!";
				misc[26] = "Piratas se acercan desde el este!";
				misc[27] = "Los piratas han llegado!";
				misc[28] = "Sientes las vibraciones de las profundidades de ...";
				misc[29] = "Esto va a ser una noche terrible ...";
				misc[30] = "El aire es más frío a su alrededor ...";
				menu[0] = "¡Comienza y únete a un nuevo periodo de Terraria!";
				menu[1] = "Ejecutándose en el puerto ";
				menu[2] = "Desconectar";
				menu[3] = "Contraseña del servidor obligatoria:";
				menu[4] = "Aceptar";
				menu[5] = "Atrás";
				menu[6] = "Cancelar";
				menu[7] = "Escribir contraseña del servidor:";
				...
				menu[27] = "Aleatorio";
				menu[28] = "Crear";
				menu[29] = "Los personajes fanáticos mueren para siempre.";
				...
				menu[55] = "Iluminación: Color";
				menu[56] = "Iluminación: Blanco";
				menu[57] = "Iluminación: Retro";
				menu[58] = "Iluminación: Psicodélica";
				menu[59] = "Calidad: Automático";
				...
				menu[69] = "Pausa automática activada";
				menu[70] = "Pausa automática desactivada";
				menu[71] = "Sugerencias activadas";
				menu[72] = "Sugerencias desactivadas";
				menu[73] = "Resolución de pantalla completa";
				menu[74] = "Arriba                 ";
				menu[75] = "Abajo                  ";
				menu[76] = "Izquierda              ";
				menu[77] = "Derecha                ";
				...
				menu[79] = "Lanzar                 ";
				menu[80] = "Inventario              ";
				menu[81] = "Curación rápida       ";
				menu[82] = "Maná rápido           ";
				menu[83] = "Extra rápido           ";
				menu[84] = "Apresar                 ";
				menu[85] = "Selección automática  ";
				menu[86] = "Volver a predeterminados";
				menu[87] = "Unirse";
				menu[88] = "Crear y Jugar";
				menu[89] = "Escribir dirección IP del servidor:";
				...
				menu[104] = "Sí";
				menu[105] = "No";
				menu[106] = "Cambiar estilo del mapa";
				menu[107] = "Alternar pantalla completa";
				menu[108] = "Acercar";
				menu[109] = "Alejar";
				menu[110] = "Disminuir Transparencia";
				menu[111] = "Aumentar la Transparencia";
				menu[112] = "Mapa Activado";
				menu[113] = "Mapa Desactivado";
				...
				gen[52] = "Comprobando alineación en cascada:";
				gen[53] = "¡Error al cargar!";
				gen[54] = "No hay copia de seguridad.";
				gen[55] = "Encontrando estructura en cascada:";
				gen[56] = "Adición de nieve ...";
				gen[57] = "Mundo";
				gen[58] = "La creación de mazmorra:";
				gen[59] = "Un meteorito ha caído!";
				gen[60] = "Suavizar el mundo:";
				gen[61] = "Mossification:";
				gen[62] = "Gemification:";
				gen[63] = "Haciendo paredes de la cueva:";
				gen[64] = "Crecimiento cuevas araña:";
				gen[65] = "Eliminación de los datos del mapa:";
				gen[66] = "Guardar los datos del mapa:";
				gen[67] = "Carga de datos de los mapas:";
				gen[68] = "Dibujo mapa:";
				gen[69] = "La creación de cascadas:";
				gen[70] = "Crear ruinas de la selva ...";
				gen[71] = "La creación de nidos de avispa ...";
				gen[72] = "Haciendo un mundo más sangrienta:";
				inter[0] = "Vida:";
				inter[1] = "Aire";
				inter[2] = "Maná";
				inter[3] = "Cubo de basura";
				inter[4] = "Inventario";
				inter[5] = "Barra de acceso rápido desbloqueada";
				inter[6] = "Barra de acceso rápido bloqueada";
				inter[7] = "Vivienda";
				inter[8] = "Búsqueda de vivienda";
				inter[9] = "Accesorios";
				inter[10] = "Defensa";
				inter[11] = "Social";
				inter[12] = "Casco";
				...
				inter[18] = "cobre";
				inter[19] = "Remodelar";
				inter[20] = "Colocar un objeto aquí para remodelarlo";
				inter[21] = "Mostrando recetas en uso";
				inter[22] = "Objetos necesarios:";
				inter[23] = "Ninguno";
				inter[24] = "Colocar un material aquí para ver las recetas";
				inter[25] = "Producción";
				inter[26] = "Monedas";
				inter[27] = "Munición";
				inter[28] = "Tienda";
				...
				inter[43] = "Ha finalizado el tiempo de conexión";
				...
				inter[53] = "De agua";
				inter[54] = "Sanar";
				inter[55] = "Esta vivienda no cumple con los requisitos para un";
				inter[56] = "Lava";
				inter[57] = "teñir";
				inter[58] = "miel";
				inter[61] = "Rebautizar";
				inter[62] = "Configuraciones";
				inter[63] = "Cancelar";
				tip[0] = "Equipado en espacio social";
				tip[1] = "No se registrará ninguna estadística";
				...
				tip[51] = "Sin valor";
				tip[52] = "consume ";
				tip[53] = " convocar a los daños";
				tip[54] = " alcance";
				tip[55] = " daño";
				mp[0] = "Recibe:";
				mp[1] = "Contraseña incorrecta.";
				mp[2] = "Operación no válida en este estado.";
				mp[3] = "Se te ha prohibido la entrada a este servidor.";
				mp[4] = "No tienes la misma versión que este servidor.";
				mp[5] = "ya está en este servidor.";
				mp[6] = "/jugando";
				mp[7] = "Jugadores ahora:";
				mp[8] = "/tira";
				mp[9] = "tira de";
				mp[10] = "¡No estás en ningún bando!";
				mp[11] = "ha activado 1c1!";
				mp[12] = "ha desactivado 1c1!";
				mp[13] = "ya no pertenece a ningún bando.";
				...
				mapLegend[Map.TileToLookup(13, 0)] = "Botella";
				mapLegend[Map.TileToLookup(14, 0)] = "Mesa";
				mapLegend[Map.TileToLookup(15, 0)] = "Silla";
				mapLegend[Map.TileToLookup(16, 0)] = "Yunque";
				mapLegend[Map.TileToLookup(17, 0)] = "Horno";
				mapLegend[Map.TileToLookup(18, 0)] = "Banco de trabajo";
				mapLegend[Map.TileToLookup(26, 0)] = "Demonio altar";
				mapLegend[Map.TileToLookup(77, 0)] = "Forjas infernal";
				mapLegend[Map.TileToLookup(86, 0)] = "Telar";
				mapLegend[Map.TileToLookup(94, 0)] = "Barrica";
				mapLegend[Map.TileToLookup(96, 0)] = "Perol";
				mapLegend[Map.TileToLookup(101, 0)] = "Librería";
				mapLegend[Map.TileToLookup(106, 0)] = "Serrería";
				mapLegend[Map.TileToLookup(114, 0)] = "Taller del reparador";
				mapLegend[Map.TileToLookup(133, 0)] = "Forja de adamantita";
				mapLegend[Map.TileToLookup(134, 0)] = "Yunque de mithril";
				prefix[1] = "Grande";
				prefix[2] = "Masivo";
				prefix[3] = "Peligroso";
				prefix[4] = "Salvaje";
				...
				prefix[10] = "Aburrido";
				prefix[11] = "Infeliz";
				prefix[12] = "Voluminoso";
				prefix[13] = "Vergonzoso";
				prefix[14] = "Pesado";
				prefix[15] = "Ligero";
				prefix[16] = "Ámbito";
				prefix[17] = "Rápido";
				prefix[18] = "Precipitado";
				prefix[19] = "Intimidante";
				prefix[20] = "Mortal";
				prefix[21] = "Firme";
				prefix[22] = "Atroz";
				prefix[23] = "Letárgico";
				...
				prefix[38] = "Fuerte";
				prefix[39] = "Roto";
				prefix[40] = "Estropeado";
				prefix[41] = "Regenerado";
				prefix[42] = "Pronto";
				prefix[43] = "Mortal";
				prefix[44] = "Ágil";
				prefix[45] = "Listo";
				...
				prefix[53] = "Hiriente";
				prefix[54] = "Vigoroso";
				prefix[55] = "Desagradable";
				prefix[56] = "Débil";
				prefix[57] = "Despiadado";
				prefix[58] = "Frenético";
				prefix[59] = "Piadoso";
				prefix[60] = "Demoníaco";
				prefix[61] = "Celoso";
				...
				prefix[66] = "Arcano";
				prefix[67] = "Preciso";
				prefix[68] = "Afortunado";
				prefix[69] = "Dentado";
				prefix[70] = "Claveteado";
				prefix[71] = "Enojado";
				prefix[72] = "Amenazador";
				prefix[73] = "Enérgico";
				prefix[74] = "Fugaz";
				prefix[75] = "Precipitado";
				prefix[76] = "Pronto";
				prefix[77] = "Salvaje";
				prefix[78] = "Temerario";
				prefix[79] = "Intrépido";
				prefix[80] = "Violento";
				prefix[81] = "Legendario";
				prefix[82] = "Irreal";
				prefix[83] = "Mítico";
			}
			for (int j = 0; j < 84; j++)
			...
			for (int k = 0; k < Main.recipe.Length; k++)
			{
				...
				{
					Main.recipe[k].createItem.name = itemName(Main.recipe[k].createItem.netID);
					Main.recipe[k].createItem.CheckTip();
					for (int l = 0; l < Main.recipe[l].requiredItem.Length; l++)
					{
						Main.recipe[k].requiredItem[l].name = itemName(Main.recipe[k].requiredItem[l].netID);
		...
		public static string deathMsg(int plr = -1, int npc = -1, int proj = -1, int other = -1)
		{
			if (lang <= 1)
			{
				...
				if (plr >= 0 && plr < 255)
				{
					result = ((proj < 0 || !(Main.projectile[proj].name != "")) ? (text + " by " + Main.player[plr].name + "'s " + Main.player[plr].inventory[Main.player[plr].selectedItem].name + ".") : (text + " by " + Main.player[plr].name + "'s " + Main.projectile[proj].name + "."));
				}
			...
			if (lang == 3)
			{
				...
				{
				case 0:
					text3 = " è stato ucciso";
					break;
				case 1:
					text3 = " è stato sventrato";
					break;
				case 2:
					text3 = " è stato assassinato";
					break;
				case 3:
					text3 = " è stato distrutto";
					break;
				case 4:
					text3 = " è stato massacrato";
					break;
				case 5:
					text3 = " è stato trafitto";
					break;
				case 6:
					text3 = " è stato diviso in due";
					break;
				case 7:
					text3 = " è stato decapitato";
					break;
				case 8:
					text3 = " ha visto uscire le sue interiora ";
					break;
				case 9:
					text3 = " è stato brutalmente sezionato";
					break;
				case 10:
					text3 = " è diventato un mucchio di carne";
					break;
				case 11:
					text3 = " è stato spezzato a metà";
					break;
				default:
					text3 = " è stato tagliato a metà";
					break;
				}
				if ((plr >= 0 && plr < 255) || (npc >= 0 && Main.npc[npc].displayName != "") || (proj >= 0 && Main.projectile[proj].name != ""))
				{
			...
			if (lang == 4)
			{
				...
				{
				case 0:
					text4 = " s'est fait éviscérer";
					break;
				case 1:
					text4 = " s'est fait assassiner";
					break;
				case 2:
					text4 = " s'est fait détruire";
					break;
				case 3:
				...
				case 5:
					...
					break;
				case 6:
					text4 = " s'est fait arracher la tête";
					break;
				case 7:
					text4 = " s'est fait déchiqueter les bras";
					break;
				case 8:
					text4 = " a vu ses entrailles tomber à ses pieds";
					break;
				case 9:
					text4 = " s'est fait brutalement découper";
					break;
				case 10:
					text4 = " a fini en chair à pâtée";
					break;
				case 11:
					text4 = " s'est fait couper en deux";
					break;
				...
				else
				{
					...
					{
					case 0:
						result4 = ((Main.rand.Next(2) != 0) ? " ne bouge plus." : " a cassé sa pipe.");
						break;
					case 1:
						switch (Main.rand.Next(4))
						{
			...
			if (lang == 5)
			{
				...
				else
				{
					...
					{
					case 0:
						result5 = ((Main.rand.Next(2) != 0) ? " no saltó a tiempo." : " le ha llegado la hora.");
						break;
					case 1:
						switch (Main.rand.Next(4))
						{
